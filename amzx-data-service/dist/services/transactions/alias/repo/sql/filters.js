...
module.exports = {
    filters: Object.assign(Object.assign({}, commonFilters), { alias: where('alias'), timeStart: byTimeStamp('>='), timeEnd: byTimeStamp('<='), blockTimeStart: byBlockTimeStamp('>='), blockTimeEnd: byBlockTimeStamp('<=') }),
