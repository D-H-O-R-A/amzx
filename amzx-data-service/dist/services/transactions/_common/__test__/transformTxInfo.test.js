...
const txRaw = {
    ...
    signature: '5CVsdA6Weyx28MyGAQoFD8HdSBMmop3RQJvGv8w4k2axRyJ4f76oV4vWoCoV31B4Dv2dRcSfG6N88AzszccH9xV',
    proofs: [],
...
describe('Common transactions info transform', () => {
    ...
    it('handles proofs/signature', () => {
        ...
        const txWithProofs = transformTxInfo(Object.assign(Object.assign({}, txRaw), { signature: null, proofs: [
    ...
    it('if tx version is null removes it', () => {
        const txVersionNull = Object.assign(Object.assign({}, txRaw), { tx_version: null });
        expect(transformTxInfo(txVersionNull)).not.toHaveProperty('version');
    });
});
//# sourceMappingURL=transformTxInfo.test.js.map