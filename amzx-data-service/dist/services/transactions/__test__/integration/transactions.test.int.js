...
const serviceInstances = zipObj(Object.keys(serviceNames), Object.values(serviceNames).map(svcName => {
...
const allServiceInstances = Object.assign(Object.assign({}, serviceInstances), { allCommonData: allCommonDataServiceCreator(commonServiceCreatorOptions), all: allServiceCreator(commonServiceCreatorOptions)(serviceInstances) });
// tests description
const services = [
    {
        name: 'genesis',
...
//# sourceMappingURL=transactions.test.int.js.map