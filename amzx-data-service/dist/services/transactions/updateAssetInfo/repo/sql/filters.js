...
module.exports = {
    filters: Object.assign(Object.assign({}, commonFilters), { assetId: where('asset_id'), timeStart: byTimeStamp('>='), timeEnd: byTimeStamp('<='), blockTimeStart: byBlockTimeStamp('>='), blockTimeEnd: byBlockTimeStamp('<=') }),
