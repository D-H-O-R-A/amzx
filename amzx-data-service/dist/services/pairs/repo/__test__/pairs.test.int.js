...
describe('Pairs', () => {
    ...
    describe('get one pair', () => {
        it('should return Pair for one correctly', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('get many pairs', () => {
        it('should return Pairs for one correctly', () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield service
                .mget({
                pairs: [
                    {
    ...
    describe('search pairs', () => {
        it('should return Pairs correctly', () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield service
                .search({
                matcher: options.matcher.defaultMatcherAddress,
...
//# sourceMappingURL=pairs.test.int.js.map