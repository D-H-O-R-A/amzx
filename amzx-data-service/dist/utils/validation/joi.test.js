...
const { serialize, deserialize, } = require('../../services/transactions/_common/cursor');
...
describe('Joi extended with custom types', () => {
    ...
    it('should validate bignumbers correctly', () => {
        ...
        expect(error.error.toString()).toContain('The number 9223372036854775808 is outside int64 range');
    });
    describe('period', () => {
        ...
        it('should validates accepted intervals correclty', () => {
            const validatePeriod = validate(Joi.string().period().accept(['m', 'h', 'd']));
...
//# sourceMappingURL=joi.test.js.map