 ...
 */
var hasPath = /*#__PURE__*/(0, _ramda.curryN)(2, function (objPath, obj) {
  var prop = (0, _ramda.head)(objPath);

  // termination conditions
  if ((0, _ramda.length)(objPath) === 0 || !(0, _isObj2.default)(obj)) {
    return false;
  } else if ((0, _ramda.length)(objPath) === 1) {
