...
$root.waves = (function() {
    ...
    waves.TransactionStateSnapshot = (function() {

        function TransactionStateSnapshot(p) {
            this.balances = [];
            this.leaseBalances = [];
            this.newLeases = [];
            this.cancelledLeases = [];
            this.assetStatics = [];
            this.assetVolumes = [];
            this.assetNamesAndDescriptions = [];
            this.orderFills = [];
            this.accountData = [];
            this.sponsorships = [];
            if (p)
        ...
        TransactionStateSnapshot.prototype.balances = $util.emptyArray;
        TransactionStateSnapshot.prototype.leaseBalances = $util.emptyArray;
        TransactionStateSnapshot.prototype.newLeases = $util.emptyArray;
        TransactionStateSnapshot.prototype.cancelledLeases = $util.emptyArray;
        TransactionStateSnapshot.prototype.assetStatics = $util.emptyArray;
        TransactionStateSnapshot.prototype.assetVolumes = $util.emptyArray;
        TransactionStateSnapshot.prototype.assetNamesAndDescriptions = $util.emptyArray;
        TransactionStateSnapshot.prototype.assetScripts = null;
        TransactionStateSnapshot.prototype.aliases = null;
        TransactionStateSnapshot.prototype.orderFills = $util.emptyArray;
        TransactionStateSnapshot.prototype.accountScripts = null;
        TransactionStateSnapshot.prototype.accountData = $util.emptyArray;
        TransactionStateSnapshot.prototype.sponsorships = $util.emptyArray;
        TransactionStateSnapshot.prototype.transactionStatus = 0;
        TransactionStateSnapshot.prototype.generationCommitment = null;

        TransactionStateSnapshot.encode = function encode(m, w) {
            if (!w)
                w = $Writer.create();
            if (m.balances != null && m.balances.length) {
                for (var i = 0; i < m.balances.length; ++i)
                    $root.waves.TransactionStateSnapshot.Balance.encode(m.balances[i], w.uint32(10).fork()).ldelim();
            }
            if (m.leaseBalances != null && m.leaseBalances.length) {
                for (var i = 0; i < m.leaseBalances.length; ++i)
                    $root.waves.TransactionStateSnapshot.LeaseBalance.encode(m.leaseBalances[i], w.uint32(18).fork()).ldelim();
            }
            if (m.newLeases != null && m.newLeases.length) {
                for (var i = 0; i < m.newLeases.length; ++i)
                    $root.waves.TransactionStateSnapshot.NewLease.encode(m.newLeases[i], w.uint32(26).fork()).ldelim();
            }
            if (m.cancelledLeases != null && m.cancelledLeases.length) {
                for (var i = 0; i < m.cancelledLeases.length; ++i)
                    $root.waves.TransactionStateSnapshot.CancelledLease.encode(m.cancelledLeases[i], w.uint32(34).fork()).ldelim();
            }
            if (m.assetStatics != null && m.assetStatics.length) {
                for (var i = 0; i < m.assetStatics.length; ++i)
                    $root.waves.TransactionStateSnapshot.NewAsset.encode(m.assetStatics[i], w.uint32(42).fork()).ldelim();
            }
            if (m.assetVolumes != null && m.assetVolumes.length) {
                for (var i = 0; i < m.assetVolumes.length; ++i)
                    $root.waves.TransactionStateSnapshot.AssetVolume.encode(m.assetVolumes[i], w.uint32(50).fork()).ldelim();
            }
            if (m.assetNamesAndDescriptions != null && m.assetNamesAndDescriptions.length) {
                for (var i = 0; i < m.assetNamesAndDescriptions.length; ++i)
                    $root.waves.TransactionStateSnapshot.AssetNameAndDescription.encode(m.assetNamesAndDescriptions[i], w.uint32(58).fork()).ldelim();
            }
            if (m.assetScripts != null && Object.hasOwnProperty.call(m, "assetScripts"))
                $root.waves.TransactionStateSnapshot.AssetScript.encode(m.assetScripts, w.uint32(66).fork()).ldelim();
            if (m.aliases != null && Object.hasOwnProperty.call(m, "aliases"))
                $root.waves.TransactionStateSnapshot.Alias.encode(m.aliases, w.uint32(74).fork()).ldelim();
            if (m.orderFills != null && m.orderFills.length) {
                for (var i = 0; i < m.orderFills.length; ++i)
                    $root.waves.TransactionStateSnapshot.OrderFill.encode(m.orderFills[i], w.uint32(82).fork()).ldelim();
            }
            if (m.accountScripts != null && Object.hasOwnProperty.call(m, "accountScripts"))
                $root.waves.TransactionStateSnapshot.AccountScript.encode(m.accountScripts, w.uint32(90).fork()).ldelim();
            if (m.accountData != null && m.accountData.length) {
                for (var i = 0; i < m.accountData.length; ++i)
                    $root.waves.TransactionStateSnapshot.AccountData.encode(m.accountData[i], w.uint32(98).fork()).ldelim();
            }
            if (m.sponsorships != null && m.sponsorships.length) {
                for (var i = 0; i < m.sponsorships.length; ++i)
                    $root.waves.TransactionStateSnapshot.Sponsorship.encode(m.sponsorships[i], w.uint32(106).fork()).ldelim();
            }
            if (m.transactionStatus != null && Object.hasOwnProperty.call(m, "transactionStatus"))
                w.uint32(112).int32(m.transactionStatus);
            if (m.generationCommitment != null && Object.hasOwnProperty.call(m, "generationCommitment"))
                $root.waves.TransactionStateSnapshot.GenerationCommitment.encode(m.generationCommitment, w.uint32(122).fork()).ldelim();
            return w;
        };

        TransactionStateSnapshot.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.TransactionStateSnapshot();
            while (r.pos < c) {
                var t = r.uint32();
                if (t === e)
                    break;
                ...
                case 1: {
                        if (!(m.balances && m.balances.length))
                            m.balances = [];
                        m.balances.push($root.waves.TransactionStateSnapshot.Balance.decode(r, r.uint32()));
                        break;
                    }
                case 2: {
                        if (!(m.leaseBalances && m.leaseBalances.length))
                            m.leaseBalances = [];
                        m.leaseBalances.push($root.waves.TransactionStateSnapshot.LeaseBalance.decode(r, r.uint32()));
                        break;
                    }
                case 3: {
                        if (!(m.newLeases && m.newLeases.length))
                            m.newLeases = [];
                        m.newLeases.push($root.waves.TransactionStateSnapshot.NewLease.decode(r, r.uint32()));
                        break;
                    }
                case 4: {
                        if (!(m.cancelledLeases && m.cancelledLeases.length))
                            m.cancelledLeases = [];
                        m.cancelledLeases.push($root.waves.TransactionStateSnapshot.CancelledLease.decode(r, r.uint32()));
                        break;
                    }
                case 5: {
                        if (!(m.assetStatics && m.assetStatics.length))
                            m.assetStatics = [];
                        m.assetStatics.push($root.waves.TransactionStateSnapshot.NewAsset.decode(r, r.uint32()));
                        break;
                    }
                case 6: {
                        if (!(m.assetVolumes && m.assetVolumes.length))
                            m.assetVolumes = [];
                        m.assetVolumes.push($root.waves.TransactionStateSnapshot.AssetVolume.decode(r, r.uint32()));
                        break;
                    }
                case 7: {
                        if (!(m.assetNamesAndDescriptions && m.assetNamesAndDescriptions.length))
                            m.assetNamesAndDescriptions = [];
                        m.assetNamesAndDescriptions.push($root.waves.TransactionStateSnapshot.AssetNameAndDescription.decode(r, r.uint32()));
                        break;
                    }
                case 8: {
                        m.assetScripts = $root.waves.TransactionStateSnapshot.AssetScript.decode(r, r.uint32());
                        break;
                    }
                case 9: {
                        m.aliases = $root.waves.TransactionStateSnapshot.Alias.decode(r, r.uint32());
                        break;
                    }
                case 10: {
                        if (!(m.orderFills && m.orderFills.length))
                            m.orderFills = [];
                        m.orderFills.push($root.waves.TransactionStateSnapshot.OrderFill.decode(r, r.uint32()));
                        break;
                    }
                case 11: {
                        m.accountScripts = $root.waves.TransactionStateSnapshot.AccountScript.decode(r, r.uint32());
                        break;
                    }
                case 12: {
                        if (!(m.accountData && m.accountData.length))
                            m.accountData = [];
                        m.accountData.push($root.waves.TransactionStateSnapshot.AccountData.decode(r, r.uint32()));
                        break;
                    }
                case 13: {
                        if (!(m.sponsorships && m.sponsorships.length))
                            m.sponsorships = [];
                        m.sponsorships.push($root.waves.TransactionStateSnapshot.Sponsorship.decode(r, r.uint32()));
                        break;
                    }
                case 14: {
                        m.transactionStatus = r.int32();
                        break;
                    }
                case 15: {
                        m.generationCommitment = $root.waves.TransactionStateSnapshot.GenerationCommitment.decode(r, r.uint32());
                        break;
                    }
                default:
                    r.skipType(t & 7);
        ...
        TransactionStateSnapshot.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.TransactionStateSnapshot";
        };

        TransactionStateSnapshot.Balance = (function() {
            ...
            Balance.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.TransactionStateSnapshot.Balance();
                while (r.pos < c) {
                    var t = r.uint32();
                    if (t === e)
                        break;
            ...
            Balance.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/waves.TransactionStateSnapshot.Balance";
            };

            return Balance;
        })();

        TransactionStateSnapshot.LeaseBalance = (function() {

            function LeaseBalance(p) {
                if (p)
                    for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                        if (p[ks[i]] != null)
                            this[ks[i]] = p[ks[i]];
            ...
            LeaseBalance.prototype.address = $util.newBuffer([]);
            LeaseBalance.prototype["in"] = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
            LeaseBalance.prototype.out = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

            LeaseBalance.encode = function encode(m, w) {
                if (!w)
                    w = $Writer.create();
                if (m.address != null && Object.hasOwnProperty.call(m, "address"))
                    w.uint32(10).bytes(m.address);
                if (m["in"] != null && Object.hasOwnProperty.call(m, "in"))
                    w.uint32(16).int64(m["in"]);
                if (m.out != null && Object.hasOwnProperty.call(m, "out"))
                    w.uint32(24).int64(m.out);
                return w;
            };

            LeaseBalance.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.TransactionStateSnapshot.LeaseBalance();
                while (r.pos < c) {
                    var t = r.uint32();
                    if (t === e)
                        break;
            ...
            LeaseBalance.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/waves.TransactionStateSnapshot.LeaseBalance";
            };

            return LeaseBalance;
        })();

        TransactionStateSnapshot.NewLease = (function() {
            ...
            NewLease.prototype.leaseId = $util.newBuffer([]);
            NewLease.prototype.senderPublicKey = $util.newBuffer([]);
            NewLease.prototype.recipientAddress = $util.newBuffer([]);
            NewLease.prototype.amount = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

            NewLease.encode = function encode(m, w) {
                if (!w)
                    w = $Writer.create();
                ...
                if (m.recipientAddress != null && Object.hasOwnProperty.call(m, "recipientAddress"))
                    w.uint32(26).bytes(m.recipientAddress);
                if (m.amount != null && Object.hasOwnProperty.call(m, "amount"))
                    w.uint32(32).int64(m.amount);
                return w;
            };

            NewLease.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.TransactionStateSnapshot.NewLease();
                while (r.pos < c) {
                    var t = r.uint32();
                    if (t === e)
                        break;
            ...
            NewLease.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/waves.TransactionStateSnapshot.NewLease";
            };

            return NewLease;
        })();

        TransactionStateSnapshot.CancelledLease = (function() {

            function CancelledLease(p) {
                if (p)
                    for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                        if (p[ks[i]] != null)
                            this[ks[i]] = p[ks[i]];
            ...
            CancelledLease.prototype.leaseId = $util.newBuffer([]);

            CancelledLease.encode = function encode(m, w) {
                if (!w)
                    w = $Writer.create();
                if (m.leaseId != null && Object.hasOwnProperty.call(m, "leaseId"))
                    w.uint32(10).bytes(m.leaseId);
            ...
            CancelledLease.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.TransactionStateSnapshot.CancelledLease();
                while (r.pos < c) {
                    var t = r.uint32();
                    if (t === e)
                        break;
            ...
            CancelledLease.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/waves.TransactionStateSnapshot.CancelledLease";
            };

            return CancelledLease;
        })();

        TransactionStateSnapshot.NewAsset = (function() {
            ...
            NewAsset.prototype.assetId = $util.newBuffer([]);
            NewAsset.prototype.issuerPublicKey = $util.newBuffer([]);
            NewAsset.prototype.decimals = 0;
            NewAsset.prototype.nft = false;

            NewAsset.encode = function encode(m, w) {
                if (!w)
                    w = $Writer.create();
                if (m.assetId != null && Object.hasOwnProperty.call(m, "assetId"))
                    w.uint32(10).bytes(m.assetId);
                if (m.issuerPublicKey != null && Object.hasOwnProperty.call(m, "issuerPublicKey"))
                    w.uint32(18).bytes(m.issuerPublicKey);
                ...
                if (m.nft != null && Object.hasOwnProperty.call(m, "nft"))
                    w.uint32(32).bool(m.nft);
                return w;
            };

            NewAsset.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.TransactionStateSnapshot.NewAsset();
                while (r.pos < c) {
                    var t = r.uint32();
                    if (t === e)
                        break;
            ...
            NewAsset.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/waves.TransactionStateSnapshot.NewAsset";
            };

            return NewAsset;
        })();

        TransactionStateSnapshot.AssetVolume = (function() {

            function AssetVolume(p) {
                if (p)
                    for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                        if (p[ks[i]] != null)
                            this[ks[i]] = p[ks[i]];
            ...
            AssetVolume.prototype.assetId = $util.newBuffer([]);
            AssetVolume.prototype.reissuable = false;
            AssetVolume.prototype.volume = $util.newBuffer([]);

            AssetVolume.encode = function encode(m, w) {
                if (!w)
                    w = $Writer.create();
                if (m.assetId != null && Object.hasOwnProperty.call(m, "assetId"))
                    w.uint32(10).bytes(m.assetId);
                ...
                if (m.volume != null && Object.hasOwnProperty.call(m, "volume"))
                    w.uint32(26).bytes(m.volume);
                return w;
            };

            AssetVolume.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.TransactionStateSnapshot.AssetVolume();
                while (r.pos < c) {
                    var t = r.uint32();
                    if (t === e)
                        break;
            ...
            AssetVolume.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/waves.TransactionStateSnapshot.AssetVolume";
            };

            return AssetVolume;
        })();

        TransactionStateSnapshot.AssetNameAndDescription = (function() {

            function AssetNameAndDescription(p) {
                if (p)
                    for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                        if (p[ks[i]] != null)
                            this[ks[i]] = p[ks[i]];
            ...
            AssetNameAndDescription.prototype.assetId = $util.newBuffer([]);
            AssetNameAndDescription.prototype.name = "";
            AssetNameAndDescription.prototype.description = "";

            AssetNameAndDescription.encode = function encode(m, w) {
                if (!w)
                    w = $Writer.create();
                if (m.assetId != null && Object.hasOwnProperty.call(m, "assetId"))
                    w.uint32(10).bytes(m.assetId);
            ...
            AssetNameAndDescription.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.TransactionStateSnapshot.AssetNameAndDescription();
                while (r.pos < c) {
                    var t = r.uint32();
                    if (t === e)
                        break;
            ...
            AssetNameAndDescription.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/waves.TransactionStateSnapshot.AssetNameAndDescription";
            };

            return AssetNameAndDescription;
        })();

        TransactionStateSnapshot.AssetScript = (function() {

            function AssetScript(p) {
                if (p)
                    for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                        if (p[ks[i]] != null)
                            this[ks[i]] = p[ks[i]];
            ...
            AssetScript.prototype.assetId = $util.newBuffer([]);
            AssetScript.prototype.script = $util.newBuffer([]);

            AssetScript.encode = function encode(m, w) {
                if (!w)
                    w = $Writer.create();
                if (m.assetId != null && Object.hasOwnProperty.call(m, "assetId"))
                    w.uint32(10).bytes(m.assetId);
            ...
            AssetScript.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.TransactionStateSnapshot.AssetScript();
                while (r.pos < c) {
                    var t = r.uint32();
                    if (t === e)
                        break;
            ...
            AssetScript.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/waves.TransactionStateSnapshot.AssetScript";
            };

            return AssetScript;
        })();

        TransactionStateSnapshot.Alias = (function() {
            ...
            Alias.prototype.address = $util.newBuffer([]);
            Alias.prototype.alias = "";

            Alias.encode = function encode(m, w) {
                if (!w)
                    w = $Writer.create();
                if (m.address != null && Object.hasOwnProperty.call(m, "address"))
                    w.uint32(10).bytes(m.address);
            ...
            Alias.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.TransactionStateSnapshot.Alias();
                while (r.pos < c) {
                    var t = r.uint32();
                    if (t === e)
                        break;
            ...
            Alias.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/waves.TransactionStateSnapshot.Alias";
            };

            return Alias;
        })();

        TransactionStateSnapshot.OrderFill = (function() {
            ...
            OrderFill.prototype.orderId = $util.newBuffer([]);
            OrderFill.prototype.volume = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
            OrderFill.prototype.fee = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

            OrderFill.encode = function encode(m, w) {
                if (!w)
                    w = $Writer.create();
                if (m.orderId != null && Object.hasOwnProperty.call(m, "orderId"))
                    w.uint32(10).bytes(m.orderId);
                if (m.volume != null && Object.hasOwnProperty.call(m, "volume"))
            ...
            OrderFill.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.TransactionStateSnapshot.OrderFill();
                while (r.pos < c) {
                    var t = r.uint32();
                    if (t === e)
                        break;
            ...
            OrderFill.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/waves.TransactionStateSnapshot.OrderFill";
            };

            return OrderFill;
        })();

        TransactionStateSnapshot.AccountScript = (function() {

            function AccountScript(p) {
                if (p)
                    for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                        if (p[ks[i]] != null)
                            this[ks[i]] = p[ks[i]];
            ...
            AccountScript.prototype.senderPublicKey = $util.newBuffer([]);
            AccountScript.prototype.script = $util.newBuffer([]);
            AccountScript.prototype.verifierComplexity = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

            AccountScript.encode = function encode(m, w) {
                if (!w)
                    w = $Writer.create();
                if (m.senderPublicKey != null && Object.hasOwnProperty.call(m, "senderPublicKey"))
                    w.uint32(10).bytes(m.senderPublicKey);
                if (m.script != null && Object.hasOwnProperty.call(m, "script"))
                    w.uint32(18).bytes(m.script);
                if (m.verifierComplexity != null && Object.hasOwnProperty.call(m, "verifierComplexity"))
                    w.uint32(24).int64(m.verifierComplexity);
                return w;
            };

            AccountScript.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.TransactionStateSnapshot.AccountScript();
                while (r.pos < c) {
                    var t = r.uint32();
                    if (t === e)
                        break;
            ...
            AccountScript.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/waves.TransactionStateSnapshot.AccountScript";
            };

            return AccountScript;
        })();

        TransactionStateSnapshot.AccountData = (function() {

            function AccountData(p) {
                this.entries = [];
                if (p)
                    for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                        if (p[ks[i]] != null)
            ...
            AccountData.prototype.address = $util.newBuffer([]);
            AccountData.prototype.entries = $util.emptyArray;

            AccountData.encode = function encode(m, w) {
                if (!w)
                    w = $Writer.create();
                if (m.address != null && Object.hasOwnProperty.call(m, "address"))
                    w.uint32(10).bytes(m.address);
                if (m.entries != null && m.entries.length) {
                    for (var i = 0; i < m.entries.length; ++i)
                        $root.waves.DataEntry.encode(m.entries[i], w.uint32(18).fork()).ldelim();
                }
                return w;
            };

            AccountData.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.TransactionStateSnapshot.AccountData();
                while (r.pos < c) {
                    var t = r.uint32();
                    if (t === e)
                        break;
                    ...
                    case 2: {
                            if (!(m.entries && m.entries.length))
                                m.entries = [];
                            m.entries.push($root.waves.DataEntry.decode(r, r.uint32()));
                            break;
                        }
                    default:
                        r.skipType(t & 7);
            ...
            AccountData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/waves.TransactionStateSnapshot.AccountData";
            };

            return AccountData;
        })();

        TransactionStateSnapshot.Sponsorship = (function() {
            ...
            Sponsorship.prototype.assetId = $util.newBuffer([]);
            Sponsorship.prototype.minFee = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

            Sponsorship.encode = function encode(m, w) {
                if (!w)
                    w = $Writer.create();
                if (m.assetId != null && Object.hasOwnProperty.call(m, "assetId"))
                    w.uint32(10).bytes(m.assetId);
                if (m.minFee != null && Object.hasOwnProperty.call(m, "minFee"))
                    w.uint32(16).int64(m.minFee);
                return w;
            };

            Sponsorship.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.TransactionStateSnapshot.Sponsorship();
                while (r.pos < c) {
                    var t = r.uint32();
                    if (t === e)
                        break;
            ...
            Sponsorship.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/waves.TransactionStateSnapshot.Sponsorship";
            };

            return Sponsorship;
        })();

        TransactionStateSnapshot.GenerationCommitment = (function() {

            function GenerationCommitment(p) {
                if (p)
                    for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                        if (p[ks[i]] != null)
                            this[ks[i]] = p[ks[i]];
            ...
            GenerationCommitment.prototype.senderPublicKey = $util.newBuffer([]);
            GenerationCommitment.prototype.endorserPublicKey = $util.newBuffer([]);

            GenerationCommitment.encode = function encode(m, w) {
                if (!w)
                    w = $Writer.create();
                if (m.senderPublicKey != null && Object.hasOwnProperty.call(m, "senderPublicKey"))
                    w.uint32(10).bytes(m.senderPublicKey);
                if (m.endorserPublicKey != null && Object.hasOwnProperty.call(m, "endorserPublicKey"))
                    w.uint32(18).bytes(m.endorserPublicKey);
                return w;
            };

            GenerationCommitment.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.TransactionStateSnapshot.GenerationCommitment();
                while (r.pos < c) {
                    var t = r.uint32();
                    if (t === e)
                        break;
            ...
            GenerationCommitment.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/waves.TransactionStateSnapshot.GenerationCommitment";
            };

            return GenerationCommitment;
        })();

        return TransactionStateSnapshot;
    })();

    waves.TransactionStatus = (function() {
        var valuesById = {}, values = Object.create(valuesById);
        values[valuesById[0] = "SUCCEEDED"] = 0;
        values[valuesById[1] = "FAILED"] = 1;
        values[valuesById[2] = "ELIDED"] = 2;
        return values;
    })();
    ...
    waves.Amount = (function() {
        ...
        Amount.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        Amount.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/waves.Amount";
        };
    ...
    waves.SignedTransaction = (function() {
        ...
        SignedTransaction.encode = function encode(m, w) {
            if (!w)
                w = $Writer.create();
            if (m.wavesTransaction != null && Object.hasOwnProperty.call(m, "wavesTransaction"))
        ...
        SignedTransaction.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/waves.SignedTransaction";
        };
    ...
    waves.Transaction = (function() {
        ...
        Transaction.prototype.commitToGeneration = null;

        var $oneOfFields;

        Object.defineProperty(Transaction.prototype, "data", {
            get: $util.oneOfGetter($oneOfFields = ["genesis", "payment", "issue", "transfer", "reissue", "burn", "exchange", "lease", "leaseCancel", "createAlias", "massTransfer", "dataTransaction", "setScript", "sponsorFee", "setAssetScript", "invokeScript", "updateAssetInfo", "invokeExpression", "commitToGeneration"]),
            set: $util.oneOfSetter($oneOfFields)
        });
        ...
        Transaction.encode = function encode(m, w) {
            ...
            if (m.invokeExpression != null && Object.hasOwnProperty.call(m, "invokeExpression"))
                $root.waves.InvokeExpressionTransactionData.encode(m.invokeExpression, w.uint32(954).fork()).ldelim();
            if (m.commitToGeneration != null && Object.hasOwnProperty.call(m, "commitToGeneration"))
                $root.waves.CommitToGenerationTransactionData.encode(m.commitToGeneration, w.uint32(962).fork()).ldelim();
            return w;
        };
        ...
        Transaction.decode = function decode(r, l, e) {
            ...
            while (r.pos < c) {
                ...
                case 120: {
                        m.commitToGeneration = $root.waves.CommitToGenerationTransactionData.decode(r, r.uint32());
                        break;
                    }
                default:
                    r.skipType(t & 7);
        ...
        Transaction.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/waves.Transaction";
        };
    ...
    waves.GenesisTransactionData = (function() {
        ...
        GenesisTransactionData.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        GenesisTransactionData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.GenesisTransactionData";
        };
    ...
    waves.PaymentTransactionData = (function() {
        ...
        PaymentTransactionData.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        PaymentTransactionData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.PaymentTransactionData";
        };
    ...
    waves.TransferTransactionData = (function() {
        ...
        TransferTransactionData.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        TransferTransactionData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.TransferTransactionData";
        };
    ...
    waves.CreateAliasTransactionData = (function() {
        ...
        CreateAliasTransactionData.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        CreateAliasTransactionData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.CreateAliasTransactionData";
        };

        return CreateAliasTransactionData;
    })();

    waves.DataEntry = (function() {
        ...
        DataEntry.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.DataEntry();
            while (r.pos < c) {
                var t = r.uint32();
                if (t === e)
                    break;
        ...
        DataEntry.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/waves.DataEntry";
        };
    ...
    waves.DataTransactionData = (function() {
        ...
        DataTransactionData.encode = function encode(m, w) {
            ...
            if (m.data != null && m.data.length) {
                for (var i = 0; i < m.data.length; ++i)
                    $root.waves.DataEntry.encode(m.data[i], w.uint32(10).fork()).ldelim();
            }
            return w;
        };

        DataTransactionData.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            ...
            while (r.pos < c) {
                ...
                case 1: {
                        if (!(m.data && m.data.length))
                            m.data = [];
                        m.data.push($root.waves.DataEntry.decode(r, r.uint32()));
                        break;
                    }
                default:
                    r.skipType(t & 7);
        ...
        DataTransactionData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.DataTransactionData";
        };
    ...
    waves.MassTransferTransactionData = (function() {
        ...
        MassTransferTransactionData.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        MassTransferTransactionData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.MassTransferTransactionData";
        };
        ...
        MassTransferTransactionData.Transfer = (function() {
            ...
            Transfer.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
            ...
            Transfer.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/waves.MassTransferTransactionData.Transfer";
            };
    ...
    waves.LeaseTransactionData = (function() {
        ...
        LeaseTransactionData.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        LeaseTransactionData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.LeaseTransactionData";
        };
    ...
    waves.LeaseCancelTransactionData = (function() {
        ...
        LeaseCancelTransactionData.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        LeaseCancelTransactionData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.LeaseCancelTransactionData";
        };
    ...
    waves.BurnTransactionData = (function() {
        ...
        BurnTransactionData.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        BurnTransactionData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.BurnTransactionData";
        };
    ...
    waves.IssueTransactionData = (function() {
        ...
        IssueTransactionData.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        IssueTransactionData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.IssueTransactionData";
        };
    ...
    waves.ReissueTransactionData = (function() {
        ...
        ReissueTransactionData.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        ReissueTransactionData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.ReissueTransactionData";
        };
    ...
    waves.SetAssetScriptTransactionData = (function() {
        ...
        SetAssetScriptTransactionData.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        SetAssetScriptTransactionData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.SetAssetScriptTransactionData";
        };
    ...
    waves.SetScriptTransactionData = (function() {
        ...
        SetScriptTransactionData.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        SetScriptTransactionData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.SetScriptTransactionData";
        };
    ...
    waves.ExchangeTransactionData = (function() {
        ...
        ExchangeTransactionData.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        ExchangeTransactionData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.ExchangeTransactionData";
        };
    ...
    waves.SponsorFeeTransactionData = (function() {
        ...
        SponsorFeeTransactionData.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        SponsorFeeTransactionData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.SponsorFeeTransactionData";
        };
    ...
    waves.InvokeScriptTransactionData = (function() {
        ...
        InvokeScriptTransactionData.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        InvokeScriptTransactionData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.InvokeScriptTransactionData";
        };
    ...
    waves.UpdateAssetInfoTransactionData = (function() {
        ...
        UpdateAssetInfoTransactionData.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        UpdateAssetInfoTransactionData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.UpdateAssetInfoTransactionData";
        };
    ...
    waves.InvokeExpressionTransactionData = (function() {
        ...
        InvokeExpressionTransactionData.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        InvokeExpressionTransactionData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.InvokeExpressionTransactionData";
        };

        return InvokeExpressionTransactionData;
    })();

    waves.CommitToGenerationTransactionData = (function() {

        function CommitToGenerationTransactionData(p) {
            if (p)
                for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                    if (p[ks[i]] != null)
                        this[ks[i]] = p[ks[i]];
        ...
        CommitToGenerationTransactionData.prototype.generationPeriodStart = 0;
        CommitToGenerationTransactionData.prototype.endorserPublicKey = $util.newBuffer([]);
        CommitToGenerationTransactionData.prototype.commitmentSignature = $util.newBuffer([]);

        CommitToGenerationTransactionData.encode = function encode(m, w) {
            if (!w)
                w = $Writer.create();
            if (m.generationPeriodStart != null && Object.hasOwnProperty.call(m, "generationPeriodStart"))
                w.uint32(8).uint32(m.generationPeriodStart);
            if (m.endorserPublicKey != null && Object.hasOwnProperty.call(m, "endorserPublicKey"))
                w.uint32(18).bytes(m.endorserPublicKey);
            if (m.commitmentSignature != null && Object.hasOwnProperty.call(m, "commitmentSignature"))
                w.uint32(26).bytes(m.commitmentSignature);
            return w;
        };

        CommitToGenerationTransactionData.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.CommitToGenerationTransactionData();
            while (r.pos < c) {
                var t = r.uint32();
                if (t === e)
                    break;
                switch (t >>> 3) {
                case 1: {
                        m.generationPeriodStart = r.uint32();
                        break;
                    }
                case 2: {
                        m.endorserPublicKey = r.bytes();
        ...
        CommitToGenerationTransactionData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.CommitToGenerationTransactionData";
        };

        return CommitToGenerationTransactionData;
    })();
    ...
    waves.Recipient = (function() {
        ...
        Recipient.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        Recipient.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/waves.Recipient";
        };
    ...
    waves.AssetPair = (function() {
        ...
        AssetPair.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        AssetPair.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.AssetPair";
        };
    ...
    waves.Order = (function() {
        ...
        Order.prototype.attachment = $util.newBuffer([]);
        ...
        Order.encode = function encode(m, w) {
            ...
            if (m.attachment != null && Object.hasOwnProperty.call(m, "attachment"))
                w.uint32(122).bytes(m.attachment);
            return w;
        };
        ...
        Order.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/waves.Order";
        };
    ...
    waves.BlockSnapshot = (function() {
        ...
        BlockSnapshot.prototype.blockId = $util.newBuffer([]);
        BlockSnapshot.prototype.snapshots = $util.emptyArray;

        BlockSnapshot.encode = function encode(m, w) {
            if (!w)
                w = $Writer.create();
            ...
            if (m.snapshots != null && m.snapshots.length) {
                for (var i = 0; i < m.snapshots.length; ++i)
                    $root.waves.TransactionStateSnapshot.encode(m.snapshots[i], w.uint32(18).fork()).ldelim();
            }
            return w;
        };

        BlockSnapshot.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.BlockSnapshot();
            while (r.pos < c) {
                var t = r.uint32();
                if (t === e)
                    break;
                ...
                case 2: {
                        if (!(m.snapshots && m.snapshots.length))
                            m.snapshots = [];
                        m.snapshots.push($root.waves.TransactionStateSnapshot.decode(r, r.uint32()));
                        break;
                    }
                default:
                    r.skipType(t & 7);
        ...
        BlockSnapshot.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.BlockSnapshot";
        };

        return BlockSnapshot;
    })();

    waves.MicroBlockSnapshot = (function() {

        function MicroBlockSnapshot(p) {
            this.snapshots = [];
            if (p)
                for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                    if (p[ks[i]] != null)
        ...
        MicroBlockSnapshot.prototype.totalBlockId = $util.newBuffer([]);
        MicroBlockSnapshot.prototype.snapshots = $util.emptyArray;

        MicroBlockSnapshot.encode = function encode(m, w) {
            if (!w)
                w = $Writer.create();
            if (m.totalBlockId != null && Object.hasOwnProperty.call(m, "totalBlockId"))
                w.uint32(10).bytes(m.totalBlockId);
            if (m.snapshots != null && m.snapshots.length) {
                for (var i = 0; i < m.snapshots.length; ++i)
                    $root.waves.TransactionStateSnapshot.encode(m.snapshots[i], w.uint32(18).fork()).ldelim();
            }
        ...
        MicroBlockSnapshot.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.MicroBlockSnapshot();
            while (r.pos < c) {
                var t = r.uint32();
                if (t === e)
                    break;
        ...
        MicroBlockSnapshot.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.MicroBlockSnapshot";
        };

        return MicroBlockSnapshot;
    })();

    waves.RewardShare = (function() {

        function RewardShare(p) {
            if (p)
                for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                    if (p[ks[i]] != null)
                        this[ks[i]] = p[ks[i]];
        ...
        RewardShare.prototype.address = $util.newBuffer([]);
        RewardShare.prototype.reward = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        RewardShare.encode = function encode(m, w) {
            if (!w)
                w = $Writer.create();
            if (m.address != null && Object.hasOwnProperty.call(m, "address"))
                w.uint32(10).bytes(m.address);
            if (m.reward != null && Object.hasOwnProperty.call(m, "reward"))
                w.uint32(16).int64(m.reward);
            return w;
        };

        RewardShare.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.RewardShare();
            while (r.pos < c) {
                var t = r.uint32();
                if (t === e)
                    break;
        ...
        RewardShare.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.RewardShare";
        };
    ...
    waves.InvokeScriptResult = (function() {
        ...
        InvokeScriptResult.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        InvokeScriptResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.InvokeScriptResult";
        };
        ...
        InvokeScriptResult.Payment = (function() {
            ...
            Payment.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
            ...
            Payment.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/waves.InvokeScriptResult.Payment";
            };
        ...
        InvokeScriptResult.Issue = (function() {
            ...
            Issue.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
            ...
            Issue.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/waves.InvokeScriptResult.Issue";
            };
        ...
        InvokeScriptResult.Reissue = (function() {
            ...
            Reissue.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
            ...
            Reissue.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/waves.InvokeScriptResult.Reissue";
            };
        ...
        InvokeScriptResult.Burn = (function() {
            ...
            Burn.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
            ...
            Burn.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/waves.InvokeScriptResult.Burn";
            };
        ...
        InvokeScriptResult.SponsorFee = (function() {
            ...
            SponsorFee.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
            ...
            SponsorFee.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/waves.InvokeScriptResult.SponsorFee";
            };
        ...
        InvokeScriptResult.Lease = (function() {
            ...
            Lease.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
            ...
            Lease.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/waves.InvokeScriptResult.Lease";
            };
        ...
        InvokeScriptResult.LeaseCancel = (function() {
            ...
            LeaseCancel.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
            ...
            LeaseCancel.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/waves.InvokeScriptResult.LeaseCancel";
            };
        ...
        InvokeScriptResult.ErrorMessage = (function() {
            ...
            ErrorMessage.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
            ...
            ErrorMessage.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/waves.InvokeScriptResult.ErrorMessage";
            };
        ...
        InvokeScriptResult.Call = (function() {
            ...
            Call.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/waves.InvokeScriptResult.Call";
            };
            ...
            Call.Argument = (function() {
                ...
                Argument.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                Argument.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/waves.InvokeScriptResult.Call.Argument";
                };
                ...
                Argument.List = (function() {
                    ...
                    List.decode = function decode(r, l, e) {
                        if (!(r instanceof $Reader))
                            r = $Reader.create(r);
                    ...
                    List.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                        ...
                        return typeUrlPrefix + "/waves.InvokeScriptResult.Call.Argument.List";
                    };
        ...
        InvokeScriptResult.Invocation = (function() {
            ...
            Invocation.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
            ...
            Invocation.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/waves.InvokeScriptResult.Invocation";
            };
    ...
    waves.Block = (function() {
        ...
        Block.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        Block.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/waves.Block";
        };
        ...
        Block.Header = (function() {
            ...
            Header.prototype.finalizationVoting = null;
            ...
            Header.encode = function encode(m, w) {
                ...
                if (m.stateHash != null && Object.hasOwnProperty.call(m, "stateHash"))
                    w.uint32(90).bytes(m.stateHash);
                if (m.challengedHeader != null && Object.hasOwnProperty.call(m, "challengedHeader"))
                    $root.waves.Block.Header.ChallengedHeader.encode(m.challengedHeader, w.uint32(98).fork()).ldelim();
                if (m.finalizationVoting != null && Object.hasOwnProperty.call(m, "finalizationVoting"))
                    $root.waves.FinalizationVoting.encode(m.finalizationVoting, w.uint32(106).fork()).ldelim();
                return w;
            };
            ...
            Header.decode = function decode(r, l, e) {
                ...
                while (r.pos < c) {
                    ...
                    case 13: {
                            m.finalizationVoting = $root.waves.FinalizationVoting.decode(r, r.uint32());
                            break;
                        }
                    default:
                        r.skipType(t & 7);
            ...
            Header.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/waves.Block.Header";
            };
            ...
            Header.ChallengedHeader = (function() {
                ...
                ChallengedHeader.prototype.finalizationVoting = null;
                ...
                ChallengedHeader.encode = function encode(m, w) {
                    ...
                    if (m.headerSignature != null && Object.hasOwnProperty.call(m, "headerSignature"))
                        w.uint32(66).bytes(m.headerSignature);
                    if (m.finalizationVoting != null && Object.hasOwnProperty.call(m, "finalizationVoting"))
                        $root.waves.FinalizationVoting.encode(m.finalizationVoting, w.uint32(74).fork()).ldelim();
                    return w;
                };

                ChallengedHeader.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                ChallengedHeader.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.Block.Header.ChallengedHeader";
                };
    ...
    waves.MicroBlock = (function() {
        ...
        MicroBlock.prototype.finalizationVoting = null;
        ...
        MicroBlock.encode = function encode(m, w) {
            ...
            if (m.finalizationVoting != null && Object.hasOwnProperty.call(m, "finalizationVoting"))
                $root.waves.FinalizationVoting.encode(m.finalizationVoting, w.uint32(58).fork()).ldelim();
            return w;
        };

        MicroBlock.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        MicroBlock.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.MicroBlock";
        };
    ...
    waves.SignedMicroBlock = (function() {
        ...
        SignedMicroBlock.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        SignedMicroBlock.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.SignedMicroBlock";
        };

        return SignedMicroBlock;
    })();

    waves.EndorseBlock = (function() {

        function EndorseBlock(p) {
            if (p)
                for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                    if (p[ks[i]] != null)
                        this[ks[i]] = p[ks[i]];
        ...
        EndorseBlock.prototype.endorserIndex = 0;
        EndorseBlock.prototype.finalizedBlockId = $util.newBuffer([]);
        EndorseBlock.prototype.finalizedBlockHeight = 0;
        EndorseBlock.prototype.endorsedBlockId = $util.newBuffer([]);
        EndorseBlock.prototype.signature = $util.newBuffer([]);

        EndorseBlock.encode = function encode(m, w) {
            if (!w)
                w = $Writer.create();
            if (m.endorserIndex != null && Object.hasOwnProperty.call(m, "endorserIndex"))
                w.uint32(8).int32(m.endorserIndex);
            if (m.finalizedBlockId != null && Object.hasOwnProperty.call(m, "finalizedBlockId"))
                w.uint32(18).bytes(m.finalizedBlockId);
            if (m.finalizedBlockHeight != null && Object.hasOwnProperty.call(m, "finalizedBlockHeight"))
                w.uint32(24).uint32(m.finalizedBlockHeight);
            if (m.endorsedBlockId != null && Object.hasOwnProperty.call(m, "endorsedBlockId"))
                w.uint32(34).bytes(m.endorsedBlockId);
            if (m.signature != null && Object.hasOwnProperty.call(m, "signature"))
                w.uint32(42).bytes(m.signature);
            return w;
        };

        EndorseBlock.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.EndorseBlock();
            while (r.pos < c) {
                var t = r.uint32();
                if (t === e)
                    break;
                switch (t >>> 3) {
                case 1: {
                        m.endorserIndex = r.int32();
                        break;
                    }
                case 2: {
                        m.finalizedBlockId = r.bytes();
                        break;
                    }
                case 3: {
                        m.finalizedBlockHeight = r.uint32();
                        break;
                    }
                case 4: {
                        m.endorsedBlockId = r.bytes();
                        break;
                    }
                case 5: {
                        m.signature = r.bytes();
        ...
        EndorseBlock.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.EndorseBlock";
        };

        return EndorseBlock;
    })();

    waves.FinalizationVoting = (function() {

        function FinalizationVoting(p) {
        ...
        FinalizationVoting.prototype.endorserIndexes = $util.emptyArray;
        FinalizationVoting.prototype.finalizedBlockHeight = 0;
        FinalizationVoting.prototype.aggregatedEndorsementSignature = $util.newBuffer([]);
        FinalizationVoting.prototype.conflictEndorsements = $util.emptyArray;

        FinalizationVoting.encode = function encode(m, w) {
            if (!w)
                w = $Writer.create();
            if (m.endorserIndexes != null && m.endorserIndexes.length) {
                w.uint32(10).fork();
                for (var i = 0; i < m.endorserIndexes.length; ++i)
                    w.int32(m.endorserIndexes[i]);
                w.ldelim();
            }
            if (m.finalizedBlockHeight != null && Object.hasOwnProperty.call(m, "finalizedBlockHeight"))
                w.uint32(16).int32(m.finalizedBlockHeight);
            if (m.aggregatedEndorsementSignature != null && Object.hasOwnProperty.call(m, "aggregatedEndorsementSignature"))
                w.uint32(26).bytes(m.aggregatedEndorsementSignature);
            if (m.conflictEndorsements != null && m.conflictEndorsements.length) {
                for (var i = 0; i < m.conflictEndorsements.length; ++i)
                    $root.waves.EndorseBlock.encode(m.conflictEndorsements[i], w.uint32(34).fork()).ldelim();
            }
            return w;
        };

        FinalizationVoting.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.FinalizationVoting();
            while (r.pos < c) {
                var t = r.uint32();
                if (t === e)
                    break;
                switch (t >>> 3) {
                case 1: {
                        if (!(m.endorserIndexes && m.endorserIndexes.length))
                            m.endorserIndexes = [];
                        if ((t & 7) === 2) {
                            var c2 = r.uint32() + r.pos;
                            while (r.pos < c2)
                                m.endorserIndexes.push(r.int32());
                        } else
                            m.endorserIndexes.push(r.int32());
                        break;
                    }
                case 2: {
                        m.finalizedBlockHeight = r.int32();
                        break;
                    }
                case 3: {
                        m.aggregatedEndorsementSignature = r.bytes();
                        break;
                    }
                case 4: {
                        if (!(m.conflictEndorsements && m.conflictEndorsements.length))
                            m.conflictEndorsements = [];
                        m.conflictEndorsements.push($root.waves.EndorseBlock.decode(r, r.uint32()));
                        break;
                    }
                default:
                    r.skipType(t & 7);
        ...
        FinalizationVoting.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.FinalizationVoting";
        };
    ...
    waves.node = (function() {
        ...
        node.grpc = (function() {
            ...
            grpc.TransactionsApi = (function() {
                ...
                Object.defineProperty(TransactionsApi.prototype.getTransactionSnapshots = function getTransactionSnapshots(request, callback) {
                    return this.rpcCall(getTransactionSnapshots, $root.waves.node.grpc.TransactionSnapshotsRequest, $root.waves.node.grpc.TransactionSnapshotResponse, request, callback);
                }, "name", { value: "GetTransactionSnapshots" });
            ...
            grpc.TransactionStatus = (function() {
                ...
                TransactionStatus.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                TransactionStatus.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.TransactionStatus";
                };
            ...
            grpc.TransactionResponse = (function() {
                ...
                TransactionResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/waves.node.grpc.TransactionResponse";
                };
            ...
            grpc.TransactionsRequest = (function() {
                ...
                TransactionsRequest.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                TransactionsRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.TransactionsRequest";
                };

                return TransactionsRequest;
            })();

            grpc.TransactionSnapshotResponse = (function() {

                function TransactionSnapshotResponse(p) {
                    if (p)
                        for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                            if (p[ks[i]] != null)
                                this[ks[i]] = p[ks[i]];
                ...
                TransactionSnapshotResponse.prototype.id = $util.newBuffer([]);
                TransactionSnapshotResponse.prototype.snapshot = null;

                TransactionSnapshotResponse.encode = function encode(m, w) {
                    if (!w)
                        w = $Writer.create();
                    if (m.id != null && Object.hasOwnProperty.call(m, "id"))
                        w.uint32(10).bytes(m.id);
                    if (m.snapshot != null && Object.hasOwnProperty.call(m, "snapshot"))
                        $root.waves.TransactionStateSnapshot.encode(m.snapshot, w.uint32(18).fork()).ldelim();
                    return w;
                };

                TransactionSnapshotResponse.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                    var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.node.grpc.TransactionSnapshotResponse();
                    while (r.pos < c) {
                        var t = r.uint32();
                        if (t === e)
                            break;
                        ...
                        case 2: {
                                m.snapshot = $root.waves.TransactionStateSnapshot.decode(r, r.uint32());
                                break;
                            }
                        default:
                            r.skipType(t & 7);
                ...
                TransactionSnapshotResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.TransactionSnapshotResponse";
                };

                return TransactionSnapshotResponse;
            })();

            grpc.TransactionSnapshotsRequest = (function() {

                function TransactionSnapshotsRequest(p) {
                    this.transactionIds = [];
                    if (p)
                        for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                            if (p[ks[i]] != null)
                ...
                TransactionSnapshotsRequest.prototype.transactionIds = $util.emptyArray;

                TransactionSnapshotsRequest.encode = function encode(m, w) {
                    if (!w)
                        w = $Writer.create();
                    if (m.transactionIds != null && m.transactionIds.length) {
                        for (var i = 0; i < m.transactionIds.length; ++i)
                            w.uint32(10).bytes(m.transactionIds[i]);
                    }
                    return w;
                };

                TransactionSnapshotsRequest.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                    var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.node.grpc.TransactionSnapshotsRequest();
                    while (r.pos < c) {
                        var t = r.uint32();
                        if (t === e)
                            break;
                ...
                TransactionSnapshotsRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.TransactionSnapshotsRequest";
                };

                return TransactionSnapshotsRequest;
            })();
            ...
            grpc.TransactionsByIdRequest = (function() {
                ...
                TransactionsByIdRequest.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                TransactionsByIdRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.TransactionsByIdRequest";
                };
            ...
            grpc.CalculateFeeResponse = (function() {
                ...
                CalculateFeeResponse.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                CalculateFeeResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.CalculateFeeResponse";
                };
            ...
            grpc.SignRequest = (function() {
                ...
                SignRequest.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                SignRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/waves.node.grpc.SignRequest";
                };
            ...
            grpc.InvokeScriptResultResponse = (function() {
                ...
                InvokeScriptResultResponse.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                InvokeScriptResultResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.InvokeScriptResultResponse";
                };
            ...
            grpc.BlockRequest = (function() {
                ...
                BlockRequest.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                BlockRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/waves.node.grpc.BlockRequest";
                };
            ...
            grpc.BlockRangeRequest = (function() {
                ...
                BlockRangeRequest.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                BlockRangeRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.BlockRangeRequest";
                };
            ...
            grpc.BlockWithHeight = (function() {
                ...
                BlockWithHeight.prototype.vrf = $util.newBuffer([]);
                BlockWithHeight.prototype.rewardShares = $util.emptyArray;
                ...
                BlockWithHeight.encode = function encode(m, w) {
                    ...
                    if (m.vrf != null && Object.hasOwnProperty.call(m, "vrf"))
                        w.uint32(26).bytes(m.vrf);
                    if (m.rewardShares != null && m.rewardShares.length) {
                        for (var i = 0; i < m.rewardShares.length; ++i)
                            $root.waves.RewardShare.encode(m.rewardShares[i], w.uint32(34).fork()).ldelim();
                    }
                    return w;
                };

                BlockWithHeight.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                BlockWithHeight.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.BlockWithHeight";
                };
            ...
            grpc.ActivationStatusRequest = (function() {
                ...
                ActivationStatusRequest.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                ActivationStatusRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.ActivationStatusRequest";
                };
            ...
            grpc.ActivationStatusResponse = (function() {
                ...
                ActivationStatusResponse.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                ActivationStatusResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.ActivationStatusResponse";
                };
            ...
            grpc.FeatureActivationStatus = (function() {
                ...
                FeatureActivationStatus.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                FeatureActivationStatus.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.FeatureActivationStatus";
                };
            ...
            grpc.BaseTargetResponse = (function() {
                ...
                BaseTargetResponse.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                BaseTargetResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.BaseTargetResponse";
                };
            ...
            grpc.ScoreResponse = (function() {
                ...
                ScoreResponse.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                ScoreResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.ScoreResponse";
                };
            ...
            grpc.AssetRequest = (function() {
                ...
                AssetRequest.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                AssetRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.AssetRequest";
                };
            ...
            grpc.NFTRequest = (function() {
                ...
                NFTRequest.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                NFTRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.NFTRequest";
                };
            ...
            grpc.NFTResponse = (function() {
                ...
                NFTResponse.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                NFTResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/waves.node.grpc.NFTResponse";
                };
            ...
            grpc.AssetInfoResponse = (function() {
                ...
                AssetInfoResponse.prototype.sequenceInBlock = 0;
                AssetInfoResponse.prototype.issueHeight = 0;
                ...
                AssetInfoResponse.encode = function encode(m, w) {
                    ...
                    if (m.sequenceInBlock != null && Object.hasOwnProperty.call(m, "sequenceInBlock"))
                        w.uint32(96).int32(m.sequenceInBlock);
                    if (m.issueHeight != null && Object.hasOwnProperty.call(m, "issueHeight"))
                        w.uint32(104).int32(m.issueHeight);
                    return w;
                };

                AssetInfoResponse.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                    ...
                    while (r.pos < c) {
                        ...
                        case 12: {
                                m.sequenceInBlock = r.int32();
                                break;
                            }
                        case 13: {
                                m.issueHeight = r.int32();
                                break;
                            }
                        default:
                            r.skipType(t & 7);
                ...
                AssetInfoResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.AssetInfoResponse";
                };
            ...
            grpc.AccountsApi = (function() {
                ...
                Object.defineProperty(AccountsApi.prototype.getScript = function getScript(request, callback) {
                    return this.rpcCall(getScript, $root.waves.node.grpc.AccountRequest, $root.waves.node.grpc.ScriptResponse, request, callback);
            ...
            grpc.AccountRequest = (function() {
                ...
                AccountRequest.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                AccountRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.AccountRequest";
                };
            ...
            grpc.DataRequest = (function() {
                ...
                DataRequest.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                DataRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.DataRequest";
                };
            ...
            grpc.BalancesRequest = (function() {
                ...
                BalancesRequest.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                BalancesRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/waves.node.grpc.BalancesRequest";
                };
            ...
            grpc.BalanceResponse = (function() {
                ...
                BalanceResponse.encode = function encode(m, w) {
                    if (!w)
                        w = $Writer.create();
                    if (m.waves != null && Object.hasOwnProperty.call(m, "waves"))
                ...
                BalanceResponse.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                BalanceResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.BalanceResponse";
                };
                ...
                BalanceResponse.WavesBalances = (function() {
                    ...
                    WavesBalances.decode = function decode(r, l, e) {
                        if (!(r instanceof $Reader))
                            r = $Reader.create(r);
                    ...
                    WavesBalances.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                        if (typeUrlPrefix === undefined) {
                            typeUrlPrefix = "type.googleapis.com";
                        }
                        return typeUrlPrefix + "/waves.node.grpc.BalanceResponse.WavesBalances";
                    };
            ...
            grpc.DataEntryResponse = (function() {
                ...
                DataEntryResponse.encode = function encode(m, w) {
                    ...
                    if (m.entry != null && Object.hasOwnProperty.call(m, "entry"))
                        $root.waves.DataEntry.encode(m.entry, w.uint32(18).fork()).ldelim();
                    return w;
                };

                DataEntryResponse.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                    ...
                    while (r.pos < c) {
                        ...
                        case 2: {
                                m.entry = $root.waves.DataEntry.decode(r, r.uint32());
                                break;
                            }
                        default:
                            r.skipType(t & 7);
                ...
                DataEntryResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.DataEntryResponse";
                };
            ...
            grpc.ScriptData = (function() {
                ...
                ScriptData.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                ScriptData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/waves.node.grpc.ScriptData";
                };

                return ScriptData;
            })();

            grpc.ScriptResponse = (function() {

                function ScriptResponse(p) {
                    if (p)
                        for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                            if (p[ks[i]] != null)
                                this[ks[i]] = p[ks[i]];
                ...
                ScriptResponse.prototype.scriptBytes = $util.newBuffer([]);
                ScriptResponse.prototype.scriptText = "";
                ScriptResponse.prototype.complexity = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
                ScriptResponse.prototype.publicKey = $util.newBuffer([]);

                ScriptResponse.encode = function encode(m, w) {
                    if (!w)
                        w = $Writer.create();
                    if (m.scriptBytes != null && Object.hasOwnProperty.call(m, "scriptBytes"))
                        w.uint32(10).bytes(m.scriptBytes);
                ...
                ScriptResponse.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                    var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.node.grpc.ScriptResponse();
                    while (r.pos < c) {
                        var t = r.uint32();
                        if (t === e)
                            break;
                ...
                ScriptResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.node.grpc.ScriptResponse";
                };
            ...
            grpc.LeaseResponse = (function() {
                ...
                LeaseResponse.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                LeaseResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/waves.node.grpc.LeaseResponse";
                };
    ...
    waves.DAppMeta = (function() {
        ...
        DAppMeta.decode = function decode(r, l, e) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
        ...
        DAppMeta.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/waves.DAppMeta";
        };
        ...
        DAppMeta.CallableFuncSignature = (function() {
            ...
            CallableFuncSignature.encode = function encode(m, w) {
                if (!w)
                    w = $Writer.create();
                if (m.types != null && Object.hasOwnProperty.call(m, "types"))
                    w.uint32(10).bytes(m.types);
                return w;
            };

            CallableFuncSignature.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
            ...
            CallableFuncSignature.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/waves.DAppMeta.CallableFuncSignature";
            };
        ...
        DAppMeta.CompactNameAndOriginalNamePair = (function() {
            ...
            CompactNameAndOriginalNamePair.encode = function encode(m, w) {
                if (!w)
                    w = $Writer.create();
                if (m.compactName != null && Object.hasOwnProperty.call(m, "compactName"))
                    w.uint32(10).string(m.compactName);
                if (m.originalName != null && Object.hasOwnProperty.call(m, "originalName"))
                    w.uint32(18).string(m.originalName);
                return w;
            };

            CompactNameAndOriginalNamePair.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
            ...
            CompactNameAndOriginalNamePair.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/waves.DAppMeta.CompactNameAndOriginalNamePair";
            };
    ...
    waves.events = (function() {
        ...
        events.BlockchainUpdated = (function() {
            ...
            BlockchainUpdated.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
            ...
            BlockchainUpdated.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/waves.events.BlockchainUpdated";
            };
            ...
            BlockchainUpdated.Append = (function() {
                ...
                Append.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                Append.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.events.BlockchainUpdated.Append";
                };
                ...
                Append.BlockAppend = (function() {
                    ...
                    BlockAppend.encode = function encode(m, w) {
                        ...
                        if (m.block != null && Object.hasOwnProperty.call(m, "block"))
                            $root.waves.Block.encode(m.block, w.uint32(10).fork()).ldelim();
                        if (m.updatedWavesAmount != null && Object.hasOwnProperty.call(m, "updatedWavesAmount"))
                    ...
                    BlockAppend.decode = function decode(r, l, e) {
                        if (!(r instanceof $Reader))
                            r = $Reader.create(r);
                    ...
                    BlockAppend.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                        if (typeUrlPrefix === undefined) {
                            typeUrlPrefix = "type.googleapis.com";
                        }
                        return typeUrlPrefix + "/waves.events.BlockchainUpdated.Append.BlockAppend";
                    };
                ...
                Append.MicroBlockAppend = (function() {
                    ...
                    MicroBlockAppend.decode = function decode(r, l, e) {
                        if (!(r instanceof $Reader))
                            r = $Reader.create(r);
                    ...
                    MicroBlockAppend.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                        if (typeUrlPrefix === undefined) {
                            typeUrlPrefix = "type.googleapis.com";
                        }
                        return typeUrlPrefix + "/waves.events.BlockchainUpdated.Append.MicroBlockAppend";
                    };
            ...
            BlockchainUpdated.Rollback = (function() {
                ...
                Rollback.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                Rollback.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/waves.events.BlockchainUpdated.Rollback";
                };
        ...
        events.StateUpdate = (function() {
            ...
            StateUpdate.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
            ...
            StateUpdate.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/waves.events.StateUpdate";
            };
            ...
            StateUpdate.BalanceUpdate = (function() {
                ...
                BalanceUpdate.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                BalanceUpdate.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/waves.events.StateUpdate.BalanceUpdate";
                };
            ...
            StateUpdate.LeasingUpdate = (function() {
                ...
                LeasingUpdate.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                LeasingUpdate.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.events.StateUpdate.LeasingUpdate";
                };
            ...
            StateUpdate.LeaseUpdate = (function() {
                ...
                LeaseUpdate.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                LeaseUpdate.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.events.StateUpdate.LeaseUpdate";
                };
            ...
            StateUpdate.DataEntryUpdate = (function() {
                ...
                DataEntryUpdate.encode = function encode(m, w) {
                    ...
                    if (m.dataEntry != null && Object.hasOwnProperty.call(m, "dataEntry"))
                        $root.waves.DataEntry.encode(m.dataEntry, w.uint32(18).fork()).ldelim();
                    if (m.dataEntryBefore != null && Object.hasOwnProperty.call(m, "dataEntryBefore"))
                        $root.waves.DataEntry.encode(m.dataEntryBefore, w.uint32(82).fork()).ldelim();
                    return w;
                };

                DataEntryUpdate.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                    ...
                    while (r.pos < c) {
                        ...
                        case 2: {
                                m.dataEntry = $root.waves.DataEntry.decode(r, r.uint32());
                                break;
                            }
                        case 10: {
                                m.dataEntryBefore = $root.waves.DataEntry.decode(r, r.uint32());
                                break;
                            }
                        default:
                            r.skipType(t & 7);
                ...
                DataEntryUpdate.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.events.StateUpdate.DataEntryUpdate";
                };
            ...
            StateUpdate.AssetStateUpdate = (function() {
                ...
                AssetStateUpdate.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                AssetStateUpdate.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.events.StateUpdate.AssetStateUpdate";
                };
            ...
            StateUpdate.AssetDetails = (function() {
                ...
                AssetDetails.prototype.sequenceInBlock = 0;
                AssetDetails.prototype.issueHeight = 0;
                ...
                AssetDetails.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                AssetDetails.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.events.StateUpdate.AssetDetails";
                };
                ...
                AssetDetails.AssetScriptInfo = (function() {
                    ...
                    AssetScriptInfo.decode = function decode(r, l, e) {
                        if (!(r instanceof $Reader))
                            r = $Reader.create(r);
                    ...
                    AssetScriptInfo.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                        if (typeUrlPrefix === undefined) {
                            typeUrlPrefix = "type.googleapis.com";
                        }
                        return typeUrlPrefix + "/waves.events.StateUpdate.AssetDetails.AssetScriptInfo";
                    };
            ...
            StateUpdate.AssetInfo = (function() {
                ...
                AssetInfo.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                AssetInfo.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/waves.events.StateUpdate.AssetInfo";
                };

                return AssetInfo;
            })();

            StateUpdate.ScriptUpdate = (function() {

                function ScriptUpdate(p) {
                    if (p)
                        for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                            if (p[ks[i]] != null)
                                this[ks[i]] = p[ks[i]];
                ...
                ScriptUpdate.prototype.address = $util.newBuffer([]);
                ScriptUpdate.prototype.before = $util.newBuffer([]);
                ScriptUpdate.prototype.after = $util.newBuffer([]);

                ScriptUpdate.encode = function encode(m, w) {
                    if (!w)
                        w = $Writer.create();
                    if (m.address != null && Object.hasOwnProperty.call(m, "address"))
                        w.uint32(10).bytes(m.address);
                    if (m.before != null && Object.hasOwnProperty.call(m, "before"))
                        w.uint32(18).bytes(m.before);
                    if (m.after != null && Object.hasOwnProperty.call(m, "after"))
                        w.uint32(26).bytes(m.after);
                    return w;
                };

                ScriptUpdate.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                    var c = l === undefined ? r.len : r.pos + l, m = new $root.waves.events.StateUpdate.ScriptUpdate();
                    while (r.pos < c) {
                        var t = r.uint32();
                        if (t === e)
                            break;
                ...
                ScriptUpdate.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.events.StateUpdate.ScriptUpdate";
                };
        ...
        events.TransactionMetadata = (function() {
            ...
            TransactionMetadata.encode = function encode(m, w) {
                if (!w)
                    w = $Writer.create();
                if (m.senderAddress != null && Object.hasOwnProperty.call(m, "senderAddress"))
            ...
            TransactionMetadata.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
            ...
            TransactionMetadata.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/waves.events.TransactionMetadata";
            };
            ...
            TransactionMetadata.TransferMetadata = (function() {
                ...
                TransferMetadata.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                TransferMetadata.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.events.TransactionMetadata.TransferMetadata";
                };
            ...
            TransactionMetadata.MassTransferMetadata = (function() {
                ...
                MassTransferMetadata.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                MassTransferMetadata.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.events.TransactionMetadata.MassTransferMetadata";
                };
            ...
            TransactionMetadata.ExchangeMetadata = (function() {
                ...
                ExchangeMetadata.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                ExchangeMetadata.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.events.TransactionMetadata.ExchangeMetadata";
                };
            ...
            TransactionMetadata.InvokeScriptMetadata = (function() {
                ...
                InvokeScriptMetadata.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                InvokeScriptMetadata.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.events.TransactionMetadata.InvokeScriptMetadata";
                };
                ...
                InvokeScriptMetadata.Argument = (function() {
                    ...
                    Argument.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                        ...
                        return typeUrlPrefix + "/waves.events.TransactionMetadata.InvokeScriptMetadata.Argument";
                    };
                    ...
                    Argument.List = (function() {
                        ...
                        List.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                            ...
                            return typeUrlPrefix + "/waves.events.TransactionMetadata.InvokeScriptMetadata.Argument.List";
                        };
            ...
            TransactionMetadata.LeaseMetadata = (function() {
                ...
                LeaseMetadata.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                LeaseMetadata.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.events.TransactionMetadata.LeaseMetadata";
                };
            ...
            TransactionMetadata.EthereumTransferMetadata = (function() {
                ...
                EthereumTransferMetadata.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                EthereumTransferMetadata.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.events.TransactionMetadata.EthereumTransferMetadata";
                };
            ...
            TransactionMetadata.EthereumMetadata = (function() {
                ...
                EthereumMetadata.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                EthereumMetadata.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.events.TransactionMetadata.EthereumMetadata";
                };
        ...
        events.grpc = (function() {
            ...
            grpc.GetBlockUpdateRequest = (function() {
                ...
                GetBlockUpdateRequest.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                GetBlockUpdateRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.events.grpc.GetBlockUpdateRequest";
                };
            ...
            grpc.GetBlockUpdateResponse = (function() {
                ...
                GetBlockUpdateResponse.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                GetBlockUpdateResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.events.grpc.GetBlockUpdateResponse";
                };
            ...
            grpc.GetBlockUpdatesRangeRequest = (function() {
                ...
                GetBlockUpdatesRangeRequest.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                GetBlockUpdatesRangeRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.events.grpc.GetBlockUpdatesRangeRequest";
                };
            ...
            grpc.GetBlockUpdatesRangeResponse = (function() {
                ...
                GetBlockUpdatesRangeResponse.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                GetBlockUpdatesRangeResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/waves.events.grpc.GetBlockUpdatesRangeResponse";
                };
            ...
            grpc.SubscribeRequest = (function() {
                ...
                SubscribeRequest.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                SubscribeRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/waves.events.grpc.SubscribeRequest";
                };
            ...
            grpc.SubscribeEvent = (function() {
                ...
                SubscribeEvent.decode = function decode(r, l, e) {
                    if (!(r instanceof $Reader))
                        r = $Reader.create(r);
                ...
                SubscribeEvent.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/waves.events.grpc.SubscribeEvent";
                };
...
$root.google = (function() {
    ...
    google.protobuf = (function() {
        ...
        protobuf.Empty = (function() {
            ...
            Empty.decode = function decode(r, l, e) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
