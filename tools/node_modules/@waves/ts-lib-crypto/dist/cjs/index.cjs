...
var require_sha3 = __commonJS({
  "src/libs/sha3.js"(exports2) {
    ...
    var methods = {};
    var methodNames = [];
    for (i = 0; i < algorithms2.length; ++i) {
      algorithm = algorithms2[i];
      bits = algorithm.bits;
    ...
    Keccak.prototype.update = function(message) {
      ...
      var blockCount = this.blockCount, index = 0, s = this.s, i2, code;
      while (index < length) {
        if (this.reset) {
          this.reset = false;
          blocks[0] = this.block;
    ...
    Keccak.prototype.finalize = function() {
      ...
      var i2 = this.lastByteIndex, blockCount = this.blockCount, s = this.s;
    ...
    Keccak.prototype.toString = Keccak.prototype.hex = function() {
      ...
      var extraBytes = this.extraBytes, i2 = 0, j2 = 0;
      var hex = "", block;
    ...
    exports2.keccak256 = methods.keccak_256;
  }
});

// src/libs/blake2b.js
var require_blake2b = __commonJS({
  "src/libs/blake2b.js"(exports2) {
    "use strict";
    exports2.__esModule = true;
    ...
    exports2.blake2bInit = blake2bInit;
    ...
    exports2.blake2bUpdate = blake2bUpdate;
    ...
    exports2.blake2bFinal = blake2bFinal;
    function blake2b4(input, key, outlen) {
      outlen = outlen || 64;
    ...
    exports2.blake2b = blake2b4;
    function blake2bHex(input, key, outlen) {
      var output = blake2b4(input, key, outlen);
      return toHex(output);
    }
    exports2.blake2bHex = blake2bHex;
  }
});

// src/libs/axlsign.js
var require_axlsign = __commonJS({
  "src/libs/axlsign.js"(exports2) {
    "use strict";
    exports2.__esModule = true;
    var axlsign5 = /* @__PURE__ */ Object.create(null);
    ...
    axlsign5.sharedKey = function(secretKey, publicKey3) {
      checkArrayTypes(publicKey3, secretKey);
      if (publicKey3.length !== 32)
        throw new Error("wrong public key length");
      if (secretKey.length !== 32)
        throw new Error("wrong secret key length");
      var sharedKey3 = new Uint8Array(32);
      crypto_scalarmult(sharedKey3, secretKey, publicKey3);
      return sharedKey3;
    };
    axlsign5.signMessage = function(secretKey, msg, opt_random) {
    ...
    axlsign5.openMessage = function(publicKey3, signedMsg) {
      checkArrayTypes(signedMsg, publicKey3);
      if (publicKey3.length !== 32)
        throw new Error("wrong public key length");
      var tmp = new Uint8Array(signedMsg.length);
      var mlen = curve25519_sign_open(tmp, signedMsg, signedMsg.length, publicKey3);
      if (mlen < 0)
        return null;
    ...
    axlsign5.sign = function(secretKey, msg, opt_random) {
    ...
    axlsign5.verify = function(publicKey3, msg, signature) {
      checkArrayTypes(msg, signature, publicKey3);
      ...
      for (i = 0; i < msg.length; i++)
        sm[i + 64] = msg[i];
      return curve25519_sign_open(m, sm, sm.length, publicKey3) >= 0;
    };
    axlsign5.generateKeyPair = function(seed) {
...
__export(index_exports, {
  ...
  ChaidId: () => ChaidId,
  MAIN_NET_CHAIN_ID: () => MAIN_NET_CHAIN_ID,
  PRIVATE_KEY_LENGTH: () => PRIVATE_KEY_LENGTH,
  PUBLIC_KEY_LENGTH: () => PUBLIC_KEY_LENGTH,
  SIGNATURE_LENGTH: () => SIGNATURE_LENGTH,
  Seed: () => Seed,
  TEST_NET_CHAIN_ID: () => TEST_NET_CHAIN_ID,
  address: () => address2,
  aesDecrypt: () => aesDecrypt2,
  aesEncrypt: () => aesEncrypt2,
  base16Decode: () => base16Decode2,
  base16Encode: () => base16Encode2,
  base58Decode: () => base58Decode2,
  base58Encode: () => base58Encode2,
  base64Decode: () => base64Decode2,
  base64Encode: () => base64Encode2,
  blake2b: () => blake2b3,
  buildAddress: () => buildAddress2,
  bytesToString: () => bytesToString2,
  concat: () => concat2,
  crypto: () => crypto,
  decryptSeed: () => decryptSeed2,
  encryptSeed: () => encryptSeed2,
  isPrivateKey: () => isPrivateKey,
  isPublicKey: () => isPublicKey,
  keccak: () => keccak2,
  keyPair: () => keyPair2,
  merkleVerify: () => merkleVerify2,
  messageDecrypt: () => messageDecrypt2,
  messageEncrypt: () => messageEncrypt2,
  privateKey: () => privateKey2,
  publicKey: () => publicKey2,
  random: () => random2,
  randomBytes: () => randomBytes4,
  randomSeed: () => randomSeed2,
  rsaKeyPair: () => rsaKeyPair2,
  rsaKeyPairSync: () => rsaKeyPairSync2,
  rsaSign: () => rsaSign2,
  rsaVerify: () => rsaVerify2,
  seedWithNonce: () => seedWithNonce2,
  ...
  verifyAddress: () => verifyAddress2,
  verifyPublicKey: () => verifyPublicKey2,
  verifySignature: () => verifySignature2
});
module.exports = __toCommonJS(index_exports);

// src/crypto/random.ts
var import_random = __toESM(require("node-forge/lib/random"));

// src/crypto/seed-words-list.ts
var seedWordsList = [
  "abandon",
  "ability",
  "able",
...
// src/conversions/base-xx.ts
var import_util = require("node-forge/lib/util");

// src/libs/base58.ts
var ALPHABET = "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz";
var ALPHABET_MAP = ALPHABET.split("").reduce((map, c, i) => {
  map[c] = i;
  return map;
}, {});
var base58_default = {
...
// src/conversions/base-xx.ts
var base64Decode = (input) => stringToBytes((0, import_util.decode64)(input), "raw");
var base64Encode = (input) => (0, import_util.encode64)(bytesToString(_fromIn(input), "raw"));
var base58Decode = (input) => base58_default.decode(input);
var base58Encode = (input) => base58_default.encode(_fromIn(input));
var base16Decode = (input) => stringToBytes((0, import_util.hexToBytes)(input), "raw");
var base16Encode = (input) => (0, import_util.bytesToHex)(
  bytesToString(_fromIn(input), "raw")
);

// src/conversions/param.ts
var isString = (val) => typeof val === "string" || val instanceof String;
var isUint8Array = (val) => val instanceof Uint8Array;
var isTRawStringInDiscriminator = (_) => false;
var _fromIn = (inValue) => {
  if (isString(inValue))
...
var utf8ArrayToStr = Utf8ArrayToStr();
...
// src/conversions/string-bytes.ts
var stringToBytes = (str, encoding = "utf8") => {
  if (encoding === "utf8") {
...
var bytesToString = (bytes, encoding = "utf8") => {
  if (encoding === "utf8") {
    return utf8ArrayToStr(_fromIn(bytes));
  } else if (encoding === "raw") {
    return Array.from(_fromIn(bytes)).map((byte) => String.fromCharCode(byte)).join("");
  } else {
    throw new Error(`Unsupported encoding ${encoding}`);
  }
};
...
// src/crypto/random.ts
var _random = (count) => stringToBytes(import_random.default.getBytesSync(count), "raw");
var ensureBuffer = () => {
  try {
...
var random = (count, type) => {
  switch (type) {
    case "Array8":
      return Array.from(_random(count));
    case "Array16":
      return Array.from(random(count, "Uint16Array"));
    case "Array32":
      return Array.from(random(count, "Uint32Array"));
    case "Buffer":
      ensureBuffer();
    ...
    case "Uint16Array":
      return new Uint16Array(count).map((_) => _random(2).reduce((a, b, i) => a | b << 8 * (1 - i), 0));
    case "Uint32Array":
      return new Uint32Array(count).map((_) => _random(4).reduce((a, b, i) => a | b << 8 * (1 - i), 0));
    default:
      throw new Error(type + " is unsupported.");
  }
};
var randomBytes = (length) => random(length, "Uint8Array");
var randomSeed = (wordsCount = 15) => random(wordsCount, "Array32").map((x) => seedWordsList[x % seedWordsList.length]).join(" ");

// src/crypto/encryption.ts
var forgeCipher = __toESM(require("node-forge/lib/cipher"));
var util = __toESM(require("node-forge/lib/util"));

// src/crypto/hashing.ts
var import_sha3 = __toESM(require_sha3());
var forgeHmac = __toESM(require("node-forge/lib/hmac"));
var forgeMd = __toESM(require("node-forge/lib/md"));
var import_sha256 = require("node-forge/lib/sha256");
var blake = __toESM(require_blake2b());
var _hashChain = (input) => _fromIn(keccak(blake2b2(_fromIn(input))));
var sha256 = (input) => {
  const md2 = forgeMd.algorithms.sha256.create();
  md2.update(bytesToString(input, "raw"));
  return stringToBytes(md2.digest().getBytes(), "raw");
};
var blake2b2 = (input) => blake.blake2b(_fromIn(input), null, 32);
var keccak = (input) => _fromIn(import_sha3.keccak256.array(_fromIn(input)));
var hmacSHA256 = (message, key) => {
  const hmac2 = forgeHmac.create();
  hmac2.start("sha256", bytesToString(_fromIn(key), "raw"));
  hmac2.update(bytesToString(_fromIn(message), "raw"));
  return stringToBytes(hmac2.digest().getBytes(), "raw");
};

// src/crypto/concat-split.ts
var concat = (...arrays) => arrays.reduce((a, b) => Uint8Array.from([...a, ..._fromIn(b)]), new Uint8Array(0));
var split = (binary, ...sizes) => {
  const { r, arr } = sizes.reduce((a, s) => ({ arr: a.arr.slice(s), r: [...a.r, a.arr.slice(0, s)] }), { arr: _fromIn(binary), r: [] });
  return [...r, arr];
};

// src/crypto/encryption.ts
var import_axlsign = __toESM(require_axlsign());
var aesEncrypt = (data, key, mode = "CBC", iv) => {
...
var aesDecrypt = (encryptedData, key, mode = "CBC", iv) => {
...
var messageDecrypt = (sharedKey3, encryptedMessage) => {
  const [
    version,
    Ccek,
    _CEKhmac,
  ...
  const CEK = aesDecrypt(Ccek, sharedKey3, "ECB");
  const CEKhmac = _fromIn(hmacSHA256(concat(CEK, iv), _fromIn(sharedKey3)));
...
var sharedKey = (privateKeyFrom, publicKeyTo, prefix) => {
  const sharedKey3 = import_axlsign.default.sharedKey(_fromIn(privateKeyFrom), _fromIn(publicKeyTo));
  const prefixHash = sha256(_fromRawIn(prefix));
  return hmacSHA256(sharedKey3, prefixHash);
};
...
var ADDRESS_LENGTH = 26;
var MAIN_NET_CHAIN_ID = 87;
var TEST_NET_CHAIN_ID = 84;

// src/extensions/seed.ts
var Seed = {
  isSeedWithNonce: (val) => val.nonce !== void 0,
  toBinary: (seed) => Seed.isSeedWithNonce(seed) ? { seed: Seed.toBinary(seed.seed).seed, nonce: seed.nonce } : { seed: _fromRawIn(seed), nonce: void 0 },
  toString: (seed) => bytesToString(Seed.toBinary(seed).seed)
};

// src/crypto/util.ts
var isPublicKey = (val) => val.publicKey !== void 0;
var isPrivateKey = (val) => val.privateKey !== void 0;

// src/crypto/address-keys-seed.ts
var import_axlsign2 = __toESM(require_axlsign());
var seedWithNonce = (seed, nonce) => ({ seed: Seed.toBinary(seed).seed, nonce });
var buildAddress = (publicKeyBytes, chainId = MAIN_NET_CHAIN_ID) => {
...
var buildSeedHash = (seedBytes, nonce) => {
...
var keyPair = (seed) => {
  ...
  const keys = import_axlsign2.default.generateKeyPair(seedHash);
  return {
    privateKey: keys.private,
    publicKey: keys.public
  };
};
var address = (seedOrPublicKey, chainId = MAIN_NET_CHAIN_ID) => isPublicKey(seedOrPublicKey) ? buildAddress(_fromIn(seedOrPublicKey.publicKey), chainId) : address(keyPair(seedOrPublicKey), chainId);
var publicKey = (seedOrPrivateKey) => isPrivateKey(seedOrPrivateKey) ? import_axlsign2.default.generateKeyPair(_fromIn(seedOrPrivateKey.privateKey)).public : keyPair(seedOrPrivateKey).publicKey;
var privateKey = (seed) => keyPair(seed).privateKey;

// src/crypto/sign.ts
var import_axlsign3 = __toESM(require_axlsign());
var signBytes = (seedOrPrivateKey, bytes, random3) => import_axlsign3.default.sign(
  _fromIn(isPrivateKey(seedOrPrivateKey) ? seedOrPrivateKey.privateKey : privateKey(seedOrPrivateKey)),
  _fromIn(bytes),
  _fromIn(random3 || randomBytes(64))
);

// src/extensions/chain-id.ts
var ChaidId = {
  toNumber(chainId) {
...
var import_axlsign4 = __toESM(require_axlsign());
var verifyAddress = (addr, optional) => {
  const chainId = optional ? optional.chainId : void 0;
  try {
...
var verifySignature = (publicKey3, bytes, signature) => {
  try {
    return import_axlsign4.default.verify(_fromIn(publicKey3), _fromIn(bytes), _fromIn(signature));
  } catch (error) {
    return false;
  }
};
var verifyPublicKey = (publicKey3) => _fromIn(publicKey3).length === PUBLIC_KEY_LENGTH;

// src/crypto/rsa.ts
var forge = __toESM(require("node-forge"));
var sha3 = __toESM(require("js-sha3"));
var import_js_sha256 = require("js-sha256");
var pemToBytes = (pem) => base64Decode(
  pem.trim().split(/\r\n|\n/).slice(1, -1).join("").trim()
);
var rsaKeyPairSync = (bits, e) => {
...
var rsaKeyPair = async (bits, e) => new Promise((resolve, reject) => {
  forge.pki.rsa.generateKeyPair(bits, e, function(err, kp) {
    if (err) reject(err);
    resolve({
      rsaPrivate: pemToBytes(forge.pki.privateKeyToPem(kp.privateKey)),
      rsaPublic: pemToBytes(forge.pki.publicKeyToPem(kp.publicKey))
...
var DIGEST_INFOS = {
  ...
  SHA224: {
    ...
    hash: (bytes) => forge.util.hexToBytes((0, import_js_sha256.sha224)(bytes))
  },
  SHA256: {
...
var rsaVerify = (rsaPublicKey, message, signature, digest = "SHA256") => {
  ...
  const asn12 = forge.asn1.fromDer(pubDer);
  const publicKey3 = forge.pki.publicKeyFromAsn1(asn12);
  const k = Math.ceil(publicKey3.n.bitLength() / 8);
  const emBuf = forge.util.createBuffer(publicKey3.encrypt(sigBytes, "RAW"));
  if (emBuf.length() !== k) return false;
  const em = emBuf.getBytes();
  if (em.charCodeAt(0) !== 0 || em.charCodeAt(1) !== 1) return false;
  const psEnd = em.indexOf("\0", 2);
  if (psEnd < 0) return false;
  for (let i = 2; i < psEnd; i++) {
    if (em.charCodeAt(i) !== 255) return false;
  }
  const recovered = em.substring(psEnd + 1);
  return recovered === digestInfo;
};
var rsaSign = (rsaPrivateKey, message, digest = "SHA256") => {
  const algo = DIGEST_INFOS[digest];
  if (!algo) throw new Error(`Unsupported digest: ${digest}`);
  const msgBytes = forge.util.binary.raw.encode(message);
  ...
  const asn12 = forge.asn1.fromDer(derStr);
  const privateKey3 = forge.pki.privateKeyFromAsn1(asn12);
  const k = Math.ceil(privateKey3.n.bitLength() / 8);
  const tLen = digestInfo.length;
  if (tLen > k - 11) throw new Error("Message too long for RSA key size");
  const PS = String.fromCharCode(...Array(k - tLen - 3).fill(255));
  const EM = "\0" + PS + "\0" + digestInfo;
  const sigBytes = privateKey3.decrypt(EM, "RAW");
  return new Uint8Array(forge.util.binary.raw.decode(sigBytes));
};

// src/crypto/seed-ecryption.ts
var forgeMd5 = __toESM(require("node-forge/lib/md5"));
...
function evpKdf(passphrase, salt, output = 48) {
...
var encryptSeed = (seed, password, encryptionRounds) => {
...
var decryptSeed = (encryptedSeed, password, encryptionRounds) => {
  const passphrase = strengthenPassword(password, encryptionRounds);
...
function merkleVerify(rootHash, merkleProof, leafData) {
  ...
  let leafHash = blake2b2(concat(LEAF_PREFIX, leafData));
  ...
  const rootHashFromProof = proofsWithSide.reduce(
    (acc, [side, hash]) => blake2b2(concat(INTERNAL_NODE_PREFIX, side === "R" ? concat(hash, acc) : concat(acc, hash))),
    leafHash
  );
...
function hash_to_field(msg, count, options) {
  ...
  const { p, k, m, hash, expand: expand2, DST: DST2 } = options;
...
function createBlsSig(blsPairing, PubPoint, SigPoint, isSigG1, hashToSigCurve, SignatureCoder) {
  ...
  return Object.freeze({
    ...
    keygen(seed) {
      ...
      const publicKey3 = this.getPublicKey(secretKey);
      return { secretKey, publicKey: publicKey3 };
    },
    // P = pk x G
    ...
    // e(P, H(m)) == e(G, S)
    // e(S, G) == e(H(m), P)
    verify(signature, message, publicKey3, unusedArg) {
      if (unusedArg != null)
        throw new Error("verify() expects 3 arguments");
      signature = normSig(signature);
      publicKey3 = normPub(publicKey3);
      const P = publicKey3.negate();
...
var signatureCoders = {
  ShortSignature: {
    ...
    fromHex(hex) {
      return signatureG1FromBytes(hexToBytes3(hex));
    },
    toBytes(point) {
    ...
    toHex(point) {
      return bytesToHex3(signatureG1ToBytes(point));
    }
  },
  LongSignature: {
    fromBytes(bytes) {
    ...
    fromHex(hex) {
      return signatureG2FromBytes(hexToBytes3(hex));
    },
    toBytes(point) {
    ...
    toHex(point) {
      return bytesToHex3(signatureG2ToBytes(point));
    }
  }
};
var fields = {
...
// src/crypto/bls.ts
var DST = new TextEncoder().encode("BLS_SIG_BLS12381G2_XMD:SHA-256_SSWU_RO_NUL_");
var BLS_KEYGEN_SALT_BASE = new TextEncoder().encode("BLS-SIG-KEYGEN-SALT-");
var CURVE_ORDER = BigInt("0x73eda753299d7d483339d80809a1d80553bda402fffe5bfeffffffff00000001");
var bls2 = bls12_381.longSignatures;
function mkBlsSecretKey(seed) {
  const ikm = new Uint8Array([...seed, 0]);
  const info = new Uint8Array([0, 48]);
  const okm = hkdf(sha2562, ikm, BLS_KEYGEN_SALT_BASE, info, 48);
...
var blsPublicKey = (secretKey) => {
  return bls2.getPublicKey(_fromIn(secretKey)).toBytes(true);
};
var blsKeyPair = (seed) => {
  const secretKey = mkBlsSecretKey(_fromIn(seed));
  const publicKey3 = blsPublicKey(secretKey);
  return { blsSecret: secretKey, blsPublic: publicKey3 };
};
var blsSign = (secretKey, message) => {
  const msgPoint = hashToPoint(_fromIn(message));
  return bls2.sign(msgPoint, _fromIn(secretKey)).toBytes(true);
};
var blsVerify = (publicKey3, message, signature) => {
  const msgPoint = hashToPoint(_fromIn(message));
  return bls2.verify(
    _fromIn(signature),
    msgPoint,
...
var crypto = (options) => {
  ...
  const s = options && options.seed ? options.seed : void 0;
  const seedPart = {
