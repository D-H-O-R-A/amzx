...
export declare const aesEncrypt: (data: TBinaryIn, key: TBinaryIn, mode?: AESMode, iv?: TBinaryIn) => TBytes;
export declare const aesDecrypt: (encryptedData: TBinaryIn, key: TBinaryIn, mode?: AESMode, iv?: TBinaryIn) => TBytes;
