 ...
 */
export declare const encryptSeed: (seed: string, password: string, encryptionRounds?: number) => TBase64;
export declare const decryptSeed: (encryptedSeed: TBase64, password: string, encryptionRounds?: number) => string;
