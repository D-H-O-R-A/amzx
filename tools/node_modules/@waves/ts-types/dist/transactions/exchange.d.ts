import type { ExchangeTransactionOrder, Long, SignedIExchangeTransactionOrder, WithApiMixin, WithApplicationStatus, WithId, WithVersion } from '../src';
...
export type ExchangeTransaction<LONG = Long> = ExchangeTransactionV1<LONG> | ExchangeTransactionV2<LONG> | ExchangeTransactionV3<LONG>;
export type ExchangeTransactionFromNode<LONG = Long> = SignedTransaction<ExchangeTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
};
