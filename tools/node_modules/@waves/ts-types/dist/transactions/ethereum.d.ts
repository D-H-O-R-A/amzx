...
export type EthereumTransactionV1<LONG> = WithVersion<EthereumTransactionFields<LONG> & BaseTransaction<LONG, 18>, 1>;
export type EthereumTransactionMap<LONG = Long> = {
    1: EthereumTransactionV1<LONG>;
};
export type EthereumTransaction<LONG = Long> = EthereumTransactionV1<LONG> & WithApiMixin & WithApplicationStatus & {
    feeAssetId: null;
};
