...
export type AliasTransaction<LONG = Long> = AliasTransactionV1<LONG> | AliasTransactionV2<LONG> | AliasTransactionV3<LONG>;
export type AliasTransactionFromNode<LONG = Long> = SignedTransaction<AliasTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
};
