import type { DataTransactionEntry, Long, WithApiMixin, WithApplicationStatus, WithId, WithVersion } from '../src';
...
export type DataTransaction<LONG = Long> = DataTransactionV1<LONG> | DataTransactionV2<LONG>;
export type DataTransactionFromNode<LONG = Long> = SignedTransaction<DataTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
};
