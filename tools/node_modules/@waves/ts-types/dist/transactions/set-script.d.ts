...
export type SetScriptTransaction<LONG = Long> = SetScriptTransactionV1<LONG> | SetScriptTransactionV2<LONG>;
export type SetScriptTransactionFromNode<LONG = Long> = SignedTransaction<SetScriptTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
};
