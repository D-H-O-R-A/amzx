...
export type BurnTransaction<LONG = Long> = BurnTransactionV1<LONG> | BurnTransactionV2<LONG> | BurnTransactionV3<LONG>;
export type BurnTransactionFromNode<LONG = Long> = SignedTransaction<BurnTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
};
