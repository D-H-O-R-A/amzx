...
export type SponsorshipTransaction<LONG = Long> = SponsorshipTransactionV1<LONG> | SponsorshipTransactionV2<LONG>;
export type SponsorshipTransactionFromNode<LONG = Long> = SignedTransaction<SponsorshipTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
};
