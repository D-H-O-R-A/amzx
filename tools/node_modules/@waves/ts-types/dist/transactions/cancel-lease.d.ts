import type { Long, WithApiMixin, WithApplicationStatus, WithId, WithVersion } from '../src';
import type { BaseTransaction, SignedTransaction } from './index';
import type { LeaseTransactionV1, LeaseTransactionV2, LeaseTransactionV3 } from './lease';
...
export type CancelLeaseTransaction<LONG = Long> = CancelLeaseTransactionV1<LONG> | CancelLeaseTransactionV2<LONG> | CancelLeaseTransactionV3<LONG>;
export type CancelLeaseTransactionFromNode<LONG = Long> = SignedTransaction<CancelLeaseTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
} & {
    lease: {
        id: string;
