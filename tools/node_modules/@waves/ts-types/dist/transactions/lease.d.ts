...
export type LeaseTransaction<LONG = Long> = LeaseTransactionV1<LONG> | LeaseTransactionV2<LONG> | LeaseTransactionV3<LONG>;
export type LeaseTransactionFromNode<LONG = Long> = SignedTransaction<LeaseTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
