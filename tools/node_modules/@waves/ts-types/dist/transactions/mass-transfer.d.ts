import type { Base58Bytes, Long, MassTransferItem, WithApiMixin, WithApplicationStatus, WithId, WithVersion } from '../src';
...
export type MassTransferTransaction<LONG = Long> = MassTransferTransactionV1<LONG> | MassTransferTransactionV2<LONG>;
export type MassTransferTransactionFromNode<LONG = Long> = SignedTransaction<MassTransferTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
    totalAmount: LONG;
