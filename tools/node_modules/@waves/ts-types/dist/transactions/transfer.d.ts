import type { Base58Bytes, Long, WithApiMixin, WithApplicationStatus, WithId, WithVersion } from '../src';
...
export type TransferTransaction<LONG = Long> = TransferTransactionV1<LONG> | TransferTransactionV2<LONG> | TransferTransactionV3<LONG>;
export type TransferTransactionFromNode<LONG = Long> = SignedTransaction<TransferTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin;
