...
export type ReissueTransaction<LONG = Long> = ReissueTransactionV1<LONG> | ReissueTransactionV2<LONG> | ReissueTransactionV3<LONG>;
export type ReissueTransactionFromNode<LONG = Long> = SignedTransaction<ReissueTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
};
