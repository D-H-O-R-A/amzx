import type { Base64Script, Long, WithApiMixin, WithApplicationStatus, WithId, WithVersion } from '../src';
...
export type SetAssetScriptTransaction<LONG = Long> = SetAssetScriptTransactionV1<LONG> | SetAssetScriptTransactionV2<LONG>;
export type SetAssetScriptTransactionFromNode<LONG = Long> = SignedTransaction<SetAssetScriptTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
};
