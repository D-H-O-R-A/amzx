import type { InvokeScriptCall, InvokeScriptPayment, Long, TStateChanges, WithApiMixin, WithApplicationStatus, WithId, WithVersion } from '../src';
...
export type InvokeScriptTransaction<LONG = Long> = InvokeScriptTransactionV1<LONG> | InvokeScriptTransactionV2<LONG>;
export type InvokeScriptTransactionFromNode<LONG = Long> = SignedTransaction<InvokeScriptTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
