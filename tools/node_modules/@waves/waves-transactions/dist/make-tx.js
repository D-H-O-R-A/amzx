...
const commit_to_generation_1 = require("./transactions/commit-to-generation");
...
function makeTx(params) {
    switch (params.type) {
        case ts_types_1.TRANSACTION_TYPE.ISSUE:
            return (0, issue_1.issue)(params);
        case ts_types_1.TRANSACTION_TYPE.TRANSFER:
            return (0, transfer_1.transfer)(params);
        case ts_types_1.TRANSACTION_TYPE.REISSUE:
            return (0, reissue_1.reissue)(params);
        case ts_types_1.TRANSACTION_TYPE.BURN:
            return (0, burn_1.burn)(params);
        case ts_types_1.TRANSACTION_TYPE.LEASE:
            return (0, lease_1.lease)(params);
        case ts_types_1.TRANSACTION_TYPE.CANCEL_LEASE:
            return (0, cancel_lease_1.cancelLease)(params);
        case ts_types_1.TRANSACTION_TYPE.ALIAS:
            return (0, alias_1.alias)(params);
        case ts_types_1.TRANSACTION_TYPE.MASS_TRANSFER:
            return (0, mass_transfer_1.massTransfer)(params);
        case ts_types_1.TRANSACTION_TYPE.DATA:
            return (0, data_1.data)(params);
        case ts_types_1.TRANSACTION_TYPE.SET_SCRIPT:
            return (0, set_script_1.setScript)(params);
        case ts_types_1.TRANSACTION_TYPE.SET_ASSET_SCRIPT:
            return (0, set_asset_script_1.setAssetScript)(params);
        case ts_types_1.TRANSACTION_TYPE.SPONSORSHIP:
            return (0, sponsorship_1.sponsorship)(params);
        case ts_types_1.TRANSACTION_TYPE.EXCHANGE:
            return (0, exchange_1.exchange)(params);
        case ts_types_1.TRANSACTION_TYPE.INVOKE_SCRIPT:
            return (0, invoke_script_1.invokeScript)(params);
        case ts_types_1.TRANSACTION_TYPE.UPDATE_ASSET_INFO:
            return (0, update_asset_info_1.updateAssetInfo)(params);
        case ts_types_1.TRANSACTION_TYPE.COMMIT_TO_GENERATION:
            return (0, commit_to_generation_1.commitToGeneration)(params);
...
function makeTxBytes(tx) {
    switch (tx.type) {
        case ts_types_1.TRANSACTION_TYPE.ISSUE:
            return tx.version > 2 ? (0, proto_serialize_1.txToProtoBytes)(tx) : marshall_1.binary.serializeTx(tx);
        case ts_types_1.TRANSACTION_TYPE.TRANSFER:
            return tx.version > 2 ? (0, proto_serialize_1.txToProtoBytes)(tx) : marshall_1.binary.serializeTx(tx);
        case ts_types_1.TRANSACTION_TYPE.REISSUE:
            return tx.version > 2 ? (0, proto_serialize_1.txToProtoBytes)(tx) : marshall_1.binary.serializeTx(tx);
        ...
        case ts_types_1.TRANSACTION_TYPE.ALIAS:
            return tx.version > 2 ? (0, proto_serialize_1.txToProtoBytes)(tx) : marshall_1.binary.serializeTx(tx);
        case ts_types_1.TRANSACTION_TYPE.MASS_TRANSFER:
            return tx.version > 1 ? (0, proto_serialize_1.txToProtoBytes)(tx) : marshall_1.binary.serializeTx(tx);
        case ts_types_1.TRANSACTION_TYPE.DATA:
            return tx.version > 1 ? (0, proto_serialize_1.txToProtoBytes)(tx) : marshall_1.binary.serializeTx(tx);
        case ts_types_1.TRANSACTION_TYPE.SET_SCRIPT:
            return tx.version > 1 ? (0, proto_serialize_1.txToProtoBytes)(tx) : marshall_1.binary.serializeTx(tx);
        ...
        case ts_types_1.TRANSACTION_TYPE.INVOKE_SCRIPT:
            return tx.version > 1 ? (0, proto_serialize_1.txToProtoBytes)(tx) : marshall_1.binary.serializeTx(tx);
        case ts_types_1.TRANSACTION_TYPE.UPDATE_ASSET_INFO:
            return (0, proto_serialize_1.txToProtoBytes)(tx);
        case ts_types_1.TRANSACTION_TYPE.COMMIT_TO_GENERATION:
            return (0, proto_serialize_1.txToProtoBytes)(tx);
        // case TRANSACTION_TYPE.INVOKE_EXPRESSION:
