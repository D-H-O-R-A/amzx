...
const parse_json_bignumber_1 = __importDefault(require("@waves/parse-json-bignumber/dist/parse-json-bignumber"));
const { parse, stringify } = (0, parse_json_bignumber_1.default)();
...
function parseTx(str, toLongConverter) {
    const tx = parse(str);
    return toLongConverter ? (0, index_1.convertTxLongFields)(tx, toLongConverter) : tx;
}
/**
...
function stringifyTx(tx, fromLongConverter) {
    ...
    const txWithStrings = (0, index_1.convertLongFields)(tx, schema, undefined, fromLongConverter);
...
function parseOrder(str, toLongConverter) {
    ...
    return toLongConverter ? (0, index_1.convertLongFields)(ord, schema, toLongConverter) : ord;
}
/**
...
function stringifyOrder(ord, fromLongConverter) {
    const schema = ord.version === 2 ? schemas_1.orderSchemaV2 : schemas_1.orderSchemaV1;
    const ordWithStrings = (0, index_1.convertLongFields)(ord, schema, undefined, fromLongConverter);
