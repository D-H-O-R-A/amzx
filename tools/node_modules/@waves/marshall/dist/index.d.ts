...
declare const binary: {
    serializerFromSchema: <LONG = string | number>(schema: TSchema, fromLongConverter?: TFromLongConverter<LONG>) => serializePrimitives.TSerializer<any>;
    serializeTx: typeof serializeTx;
    serializeOrder: typeof serializeOrder;
    parserFromSchema: <LONG = string>(schema: TSchema, toLongConverter?: TToLongConverter<LONG>) => parsePrimitives.TParser<any>;
