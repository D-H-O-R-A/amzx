...
exports.parsePrimitives = exports.serializePrimitives = exports.schemas = exports.binary = exports.json = void 0;
exports.convertLongFields = convertLongFields;
exports.convertTxLongFields = convertTxLongFields;
const schemas_1 = require("./schemas");
const serialize_1 = require("./serialize");
const parse_1 = require("./parse");
const json = __importStar(require("./jsonMethods"));
exports.json = json;
const serializePrimitives = __importStar(require("./serializePrimitives"));
exports.serializePrimitives = serializePrimitives;
const parsePrimitives = __importStar(require("./parsePrimitives"));
...
function convertLongFields(obj, schema, toConverter, fromConverter) {
    ...
    const ser = (0, serialize_1.serializerFromSchema)(schema, fromConverter);
    const par = (0, parse_1.parserFromSchema)(schema, toConverter);
    const converted = par(ser(obj)).value;
    return Object.assign(Object.assign({}, obj), converted);
}
