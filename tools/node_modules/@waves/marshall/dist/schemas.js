...
exports.orderVersionMap = exports.schemasByTypeMap = exports.transferSchemaV2 = exports.sponsorshipSchemaV1 = exports.setScriptSchemaV1 = exports.setAssetScriptSchemaV1 = exports.reissueSchemaV2 = exports.massTransferSchemaV1 = exports.leaseSchemaV2 = exports.issueSchemaV2 = exports.exchangeSchemaV2 = exports.exchangeSchemaV1 = exports.proofsSchemaV1 = exports.proofsSchemaV0 = exports.dataSchemaV1 = exports.invokeScriptSchemaV1 = exports.cancelLeaseSchemaV2 = exports.burnSchemaV2 = exports.aliasSchemaV2 = exports.orderSchemaV3 = exports.orderSchemaV2 = exports.orderSchemaV1 = exports.txFields = exports.TRANSACTION_TYPE = void 0;
...
(function (txFields) {
    ...
    txFields.stringField = (name) => ([name, {
            toBytes: (0, serializePrimitives_1.LEN)(serializePrimitives_1.SHORT)(serializePrimitives_1.STRING),
            fromBytes: (0, parsePrimitives_1.P_STRING_VAR)(parsePrimitives_1.P_SHORT),
        }]);
    txFields.base58field32 = (name) => ([name, {
            toBytes: serializePrimitives_1.BASE58_STRING,
            fromBytes: (0, parsePrimitives_1.P_BASE58_FIXED)(32),
        }]);
    // String 'WAVES' often used instead of null. That's why we should serialize it as null
    txFields.base58Option32 = (name) => ([name, {
            toBytes: (s) => s === 'WAVES' ? (0, serializePrimitives_1.OPTION)(serializePrimitives_1.BASE58_STRING)(null) : (0, serializePrimitives_1.OPTION)(serializePrimitives_1.BASE58_STRING)(s),
            fromBytes: (0, parsePrimitives_1.P_OPTION)((0, parsePrimitives_1.P_BASE58_FIXED)(32)),
        }]);
    txFields.base64field = (name) => ([name, {
            toBytes: (0, serializePrimitives_1.LEN)(serializePrimitives_1.SHORT)(serializePrimitives_1.BASE64_STRING),
            fromBytes: (0, parsePrimitives_1.P_BASE64)(parsePrimitives_1.P_SHORT),
        }]);
    ...
    txFields.attachment = ['attachment', {
            toBytes: (0, serializePrimitives_1.LEN)(serializePrimitives_1.SHORT)(serializePrimitives_1.BASE58_STRING),
            fromBytes: (0, parsePrimitives_1.P_BASE58_VAR)(parsePrimitives_1.P_SHORT),
        }];
    ...
    txFields.signature = ['signature', {
            toBytes: serializePrimitives_1.BASE58_STRING,
            fromBytes: (0, parsePrimitives_1.P_BASE58_FIXED)(64),
        }];
    ...
    const dataTxItem = {
        ...
        items: new Map([
            ...
            [schemaTypes_1.DATA_FIELD_TYPE.BINARY, { toBytes: (0, serializePrimitives_1.LEN)(serializePrimitives_1.SHORT)(serializePrimitives_1.BASE64_STRING), fromBytes: (0, parsePrimitives_1.P_BASE64)(parsePrimitives_1.P_SHORT) }],
            [schemaTypes_1.DATA_FIELD_TYPE.STRING, { toBytes: (0, serializePrimitives_1.LEN)(serializePrimitives_1.SHORT)(serializePrimitives_1.STRING), fromBytes: (0, parsePrimitives_1.P_STRING_VAR)(parsePrimitives_1.P_SHORT) }],
        ]),
    };
    txFields.data = ['data', {
            type: 'array',
    ...
    const functionArgumentPrimitives = [
        ...
        [1, { toBytes: (0, serializePrimitives_1.LEN)(serializePrimitives_1.INT)(serializePrimitives_1.BASE64_STRING), fromBytes: (0, parsePrimitives_1.P_BASE64)(parsePrimitives_1.P_INT) }, 'binary'],
        [2, { toBytes: (0, serializePrimitives_1.LEN)(serializePrimitives_1.INT)(serializePrimitives_1.STRING), fromBytes: (0, parsePrimitives_1.P_STRING_VAR)(parsePrimitives_1.P_INT) }, 'string'],
    ...
    const functionArgument = (0, schemaTypes_1.anyOf)([
        ...functionArgumentPrimitives,
        [11, {
                type: 'array',
                toBytes: serializePrimitives_1.INT,
                fromBytes: parsePrimitives_1.P_INT,
                items: (0, schemaTypes_1.anyOf)(functionArgumentPrimitives, { valueField: 'value' }),
            }, 'list'],
    ], { valueField: 'value' });
    txFields.functionCall = ['call', {
            ...
            schema: [
                ...
                ['function', {
                        toBytes: (0, serializePrimitives_1.LEN)(serializePrimitives_1.INT)(serializePrimitives_1.STRING),
                        fromBytes: (0, parsePrimitives_1.P_STRING_VAR)(parsePrimitives_1.P_INT),
                    }],
                ['args', {
                        type: 'array',
                        toBytes: serializePrimitives_1.INT,
...
})(txFields || (exports.txFields = txFields = {}));
exports.orderSchemaV1 = {
    ...
    schema: [
        ...
        ['orderType', {
                toBytes: (type) => (0, serializePrimitives_1.BYTE)(type === 'sell' ? 1 : 0),
                fromBytes: (bytes, start = 0) => (0, parsePrimitives_1.P_BYTE)(bytes, start).value === 1 ?
                    { value: 'sell', shift: 1 } :
                    { value: 'buy', shift: 1 },
            }],
...
exports.exchangeSchemaV1 = {
    ...
    schema: [
        ...
        ['order1', {
                ...
                toBytes: (order) => (0, serializePrimitives_1.INT)((0, serialize_1.serializerFromSchema)(orderSchemaV0WithSignature)(order).length)
            }],
        ['order2', {
                fromBytes: () => ({ value: undefined, shift: 4 }),
                toBytes: (order) => (0, serializePrimitives_1.INT)((0, serialize_1.serializerFromSchema)(orderSchemaV0WithSignature)(order).length)
...
const anyOrder = (0, schemaTypes_1.anyOf)([
    [1, {
            type: 'object',
            //order v1 length is serialized without orderVersion
            withLength: {
                toBytes: (x) => (0, serializePrimitives_1.INT)(x - 1),
                fromBytes: (x) => {
                    const { value, shift } = (0, parsePrimitives_1.P_INT)(x);
